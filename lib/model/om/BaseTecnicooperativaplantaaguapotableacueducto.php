...
abstract class BaseTecnicooperativaplantaaguapotableacueducto extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->topla_tecnologia_utilizada_cc = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->topla_tecnologia_utilizada_fd = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->topla_tecnologia_utilizada_pc = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->topla_tecnologia_utilizada_fime = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->topla_tecnologia_utilizada_ct = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->topla_tecnologia_utilizada_rhm = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->topla_ciclo_completo_mr = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->topla_ciclo_completo_flh = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->topla_ciclo_completo_flm = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->topla_ciclo_completo_sd = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->topla_ciclo_completo_fr = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->topla_filtracion_directa_mr = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->topla_filtracion_directa_flh = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->topla_filtracion_directa_flm = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->topla_filtracion_directa_fr = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->topla_fime_fgd = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->topla_fime_fgac = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->topla_fime_fgas2 = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->topla_fime_fgas3 = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->topla_fime_fla = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->topla_rhm_bandejas_cascadas = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->topla_rhm_aspersores = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
			$this->topla_rhm_sd = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
			$this->topla_rhm_fr = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
			$this->topla_rhm_fime = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
			$this->topla_planta_ttmto_funciona = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
			$this->topla_estructuras_medicion_cau = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
			$this->topla_menor_caudal_operacion_diseno = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
			$this->topla_planta_compacta = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
			$this->topla_combinacion_tecnologias = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
			$this->resetModified();
