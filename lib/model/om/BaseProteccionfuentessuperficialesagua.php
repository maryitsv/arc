...
abstract class BaseProteccionfuentessuperficialesagua extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->pfu_aislamiento_franja_amarilla_microcuenca = ($row[$startcol + 20] !== null) ? (boolean) $row[$startcol + 20] : null;
			$this->pfu_cobertura_forestal_area_protectora_cauce = ($row[$startcol + 21] !== null) ? (boolean) $row[$startcol + 21] : null;
			$this->pfu_area_microcuenca_propiedad_acueducto = ($row[$startcol + 22] !== null) ? (boolean) $row[$startcol + 22] : null;
