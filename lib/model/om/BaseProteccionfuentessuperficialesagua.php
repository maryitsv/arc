...
abstract class BaseProteccionfuentessuperficialesagua extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->pfu_programas_aislamiento = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->pfu_programas_reforestacion = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->pfu_programas_mejoramiento_uso_suelo = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->pfu_programas_adquisicion_tierra = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->pfu_programas_educacion_ambiental = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->pfu_programas_reduccion_uso_agroquimicos = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->pfu_situacion_arriba_captacion_reserva = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
			$this->pfu_situacion_arriba_captacion_protegida = ($row[$startcol + 9] !== null) ? (boolean) $row[$startcol + 9] : null;
			$this->pfu_cobertura_forestal_bosque_natural = ($row[$startcol + 10] !== null) ? (boolean) $row[$startcol + 10] : null;
			$this->pfu_cobertura_forestal_bosque_protector = ($row[$startcol + 11] !== null) ? (boolean) $row[$startcol + 11] : null;
			$this->pfu_cobertura_forestal_bosque_protector_productor = ($row[$startcol + 12] !== null) ? (boolean) $row[$startcol + 12] : null;
			$this->pfu_cobertura_forestal_productor = ($row[$startcol + 13] !== null) ? (boolean) $row[$startcol + 13] : null;
			$this->pfu_cobertura_forestal_regeneracion_natural = ($row[$startcol + 14] !== null) ? (boolean) $row[$startcol + 14] : null;
			$this->pfu_cobertura_forestal_area_protectora_cauce = ($row[$startcol + 15] !== null) ? (boolean) $row[$startcol + 15] : null;
			$this->pfu_aislamiento_franja_amarilla_microcuenca = ($row[$startcol + 16] !== null) ? (boolean) $row[$startcol + 16] : null;
			$this->pfu_area_microcuenca_propiedad_acueducto = ($row[$startcol + 17] !== null) ? (boolean) $row[$startcol + 17] : null;
			$this->resetModified();
			...
			return $startcol + 18; // 18 = ProteccionfuentessuperficialesaguaPeer::NUM_COLUMNS - ProteccionfuentessuperficialesaguaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[15] => $this->getPfuCoberturaForestalAreaProtectoraCauce(),
			$keys[16] => $this->getPfuAislamientoFranjaAmarillaMicrocuenca(),
			$keys[17] => $this->getPfuAreaMicrocuencaPropiedadAcueducto(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[15], $arr)) $this->setPfuCoberturaForestalAreaProtectoraCauce($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setPfuAislamientoFranjaAmarillaMicrocuenca($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setPfuAreaMicrocuencaPropiedadAcueducto($arr[$keys[17]]);
	}
