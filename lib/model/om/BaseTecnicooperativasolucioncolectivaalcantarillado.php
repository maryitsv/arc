...
abstract class BaseTecnicooperativasolucioncolectivaalcantarillado extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->tosca_posee_alcantarillado_colectivo = ($row[$startcol + 1] !== null) ? (boolean) $row[$startcol + 1] : null;
			$this->tosca_sanitario_funciona = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->tosca_sanitario_numero_suscriptores = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->tosca_sanitario_se_usa = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->tosca_sanitario_estado = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->tosca_pluvial_funciona = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->tosca_pluvial_numero_suscriptores = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->tosca_pluvial_se_usa = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
			$this->tosca_pluvial_estado = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->tosca_combi_convencional_funciona = ($row[$startcol + 10] !== null) ? (boolean) $row[$startcol + 10] : null;
			$this->tosca_combi_convencional_numero_suscriptores = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->tosca_combi_convencional_se_usa = ($row[$startcol + 12] !== null) ? (boolean) $row[$startcol + 12] : null;
			$this->tosca_combi_convencional_estado = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->tosca_combi_no_convencional_funciona = ($row[$startcol + 14] !== null) ? (boolean) $row[$startcol + 14] : null;
			$this->tosca_combi_no_convencional_numero_suscriptores = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			$this->tosca_combi_no_convencional_se_usa = ($row[$startcol + 16] !== null) ? (boolean) $row[$startcol + 16] : null;
			$this->tosca_combi_no_convencional_estado = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->tosca_simplificado_funciona = ($row[$startcol + 18] !== null) ? (boolean) $row[$startcol + 18] : null;
			$this->tosca_simplificado_numero_suscriptores = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->tosca_simplificado_se_usa = ($row[$startcol + 20] !== null) ? (boolean) $row[$startcol + 20] : null;
			$this->tosca_simplificado_estado = ($row[$startcol + 21] !== null) ? (int) $row[$startcol + 21] : null;
			$this->tosca_sin_arrastre_solidos_funciona = ($row[$startcol + 22] !== null) ? (boolean) $row[$startcol + 22] : null;
			$this->tosca_sin_arrastre_solidos_numero_suscriptores = ($row[$startcol + 23] !== null) ? (int) $row[$startcol + 23] : null;
			$this->tosca_sin_arrastre_solidos_se_usa = ($row[$startcol + 24] !== null) ? (boolean) $row[$startcol + 24] : null;
			...
			$this->tosca_otro_funciona = ($row[$startcol + 27] !== null) ? (boolean) $row[$startcol + 27] : null;
			$this->tosca_otro_numero_suscriptores = ($row[$startcol + 28] !== null) ? (int) $row[$startcol + 28] : null;
			$this->tosca_otro_se_usa = ($row[$startcol + 29] !== null) ? (boolean) $row[$startcol + 29] : null;
