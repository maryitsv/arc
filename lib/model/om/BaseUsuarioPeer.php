...
abstract class BaseUsuarioPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UsuId', 'UsuPerId', 'UsuLogin', 'UsuClave', 'UsuEstado', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuId', 'usuPerId', 'usuLogin', 'usuClave', 'usuEstado', ),
		BasePeer::TYPE_COLNAME => array (self::USU_ID, self::USU_PER_ID, self::USU_LOGIN, self::USU_CLAVE, self::USU_ESTADO, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_id', 'usu_per_id', 'usu_login', 'usu_clave', 'usu_estado', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UsuId' => 0, 'UsuPerId' => 1, 'UsuLogin' => 2, 'UsuClave' => 3, 'UsuEstado' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuId' => 0, 'usuPerId' => 1, 'usuLogin' => 2, 'usuClave' => 3, 'usuEstado' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::USU_ID => 0, self::USU_PER_ID => 1, self::USU_LOGIN => 2, self::USU_CLAVE => 3, self::USU_ESTADO => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_id' => 0, 'usu_per_id' => 1, 'usu_login' => 2, 'usu_clave' => 3, 'usu_estado' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UsuarioPeer::USU_PER_ID);
		$criteria->addSelectColumn(UsuarioPeer::USU_LOGIN);
		$criteria->addSelectColumn(UsuarioPeer::USU_CLAVE);
	...
	public static function doCountJoinPerfil(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(UsuarioPeer::USU_PER_ID, PerfilPeer::PER_ID, $join_behavior);
