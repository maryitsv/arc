...
abstract class BaseCalidadagua extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the cag_numero_visita_sspd field.
	 * @var        int
	 */
	protected $cag_numero_visita_sspd;
	...
	/**
	 * Get the [cag_numero_visita_sspd] column value.
	 * 
	 * @return     int
	 */
	public function getCagNumeroVisitaSspd()
	{
		return $this->cag_numero_visita_sspd;
	}
	...
	/**
	 * Set the value of [cag_numero_visita_sspd] column.
	 * 
	 * @param      int $v new value
	 * @return     Calidadagua The current object (for fluent API support)
	 */
	public function setCagNumeroVisitaSspd($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->cag_numero_visita_sspd !== $v) {
			$this->cag_numero_visita_sspd = $v;
			$this->modifiedColumns[] = CalidadaguaPeer::CAG_NUMERO_VISITA_SSPD;
		}

		return $this;
	} // setCagNumeroVisitaSspd()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cag_control_ca_fuente = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->cag_mapa_riesgo = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			$this->cag_laboratorio_propio = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->cag_control_ca_distribuida = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
			$this->cag_numero_visita_sspd = ($row[$startcol + 24] !== null) ? (int) $row[$startcol + 24] : null;
			$this->resetModified();
			...
			return $startcol + 25; // 25 = CalidadaguaPeer::NUM_COLUMNS - CalidadaguaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 23:
				...
				break;
			case 24:
				return $this->getCagNumeroVisitaSspd();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[24] => $this->getCagNumeroVisitaSspd(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 23:
				...
				break;
			case 24:
				$this->setCagNumeroVisitaSspd($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[24], $arr)) $this->setCagNumeroVisitaSspd($arr[$keys[24]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CalidadaguaPeer::CAG_NUMERO_VISITA_SSPD)) $criteria->add(CalidadaguaPeer::CAG_NUMERO_VISITA_SSPD, $this->cag_numero_visita_sspd);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCagNumeroVisitaSspd($this->cag_numero_visita_sspd);
