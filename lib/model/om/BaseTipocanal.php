...
/**
 * Base class that represents a row from the 'tipocanal' table.
 *
 * 
 *
 ...
 */
abstract class BaseTipocanal extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the tca_id field.
	 * @var        int
	 */
	protected $tca_id;

	/**
	 * The value for the tca_nombre field.
	 * @var        string
	 */
	protected $tca_nombre;
	...
	const PEER = 'TipocanalPeer';

	/**
	 * Get the [tca_id] column value.
	 * 
	 * @return     int
	 */
	public function getTcaId()
	{
		return $this->tca_id;
	}

	/**
	 * Get the [tca_nombre] column value.
	 * 
	 * @return     string
	 */
	public function getTcaNombre()
	{
		return $this->tca_nombre;
	}

	/**
	 * Set the value of [tca_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Tipocanal The current object (for fluent API support)
	 */
	public function setTcaId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->tca_id !== $v) {
			$this->tca_id = $v;
			$this->modifiedColumns[] = TipocanalPeer::TCA_ID;
		}
	...
	/**
	 * Set the value of [tca_nombre] column.
	 * 
	 * @param      string $v new value
	 * @return     Tipocanal The current object (for fluent API support)
	 */
	public function setTcaNombre($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->tca_nombre !== $v) {
			$this->tca_nombre = $v;
			$this->modifiedColumns[] = TipocanalPeer::TCA_NOMBRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->tca_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->tca_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = TipocanalPeer::NUM_COLUMNS - TipocanalPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tipocanal object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TipocanalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTipocanal:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TipocanalPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTipocanal:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTipocanal:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTipocanal:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				TipocanalPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TipocanalPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setTcaId($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TipocanalPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TipocanalPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TipocanalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				return $this->getTcaId();
				break;
			case 1:
				return $this->getTcaNombre();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = TipocanalPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getTcaId(),
			$keys[1] => $this->getTcaNombre(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setTcaId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setTcaNombre($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TipocanalPeer::TCA_ID)) $criteria->add(TipocanalPeer::TCA_ID, $this->tca_id);
		if ($this->isColumnModified(TipocanalPeer::TCA_NOMBRE)) $criteria->add(TipocanalPeer::TCA_NOMBRE, $this->tca_nombre);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TipocanalPeer::TCA_ID, $this->tca_id);
	...
	/**
	 * Generic method to set the primary key (tca_id column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tipocanal (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTcaNombre($this->tca_nombre);
		...
		$copyObj->setTcaId(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tipocanal Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TipocanalPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TipocanalPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Tipocanal has previously been saved, it will retrieve
	 * related Tecnicooperativaaduccionimpulsionacueductos from storage. If this Tipocanal is new, it will return
		...
		if ($this->collTecnicooperativaaduccionimpulsionacueductos === null) {
			if ($this->isNew()) {
			   $this->collTecnicooperativaaduccionimpulsionacueductos = array();
				...
				$criteria->add(TecnicooperativaaduccionimpulsionacueductoPeer::TOAI_TIPO_CANAL_ID, $this->tca_id);
	 ...
	 * Otherwise if this Tipocanal is new, it will return
	 * an empty collection; or if this Tipocanal has previously
	 * been saved, it will retrieve related Tecnicooperativaaduccionimpulsionacueductos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tipocanal.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tipocanal has previously been saved, it will retrieve
	 * related Tecnicooperativalineaconduccionaguacrudaacueductos from storage. If this Tipocanal is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTecnicooperativalineaconduccionaguacrudaacueductos === null) {
			if ($this->isNew()) {
			   $this->collTecnicooperativalineaconduccionaguacrudaacueductos = array();
				...
				$criteria->add(TecnicooperativalineaconduccionaguacrudaacueductoPeer::TOLC_TIPO_CANAL_ID, $this->tca_id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTipocanal:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTipocanal::%s', $method));
	  }
