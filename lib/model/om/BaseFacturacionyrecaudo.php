...
abstract class BaseFacturacionyrecaudo extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fac_frecuencia_del_servicio = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			...
			$this->fac_sist_fac_utilizado = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aCormecial !== null && $this->fac_com_id !== $this->aCormecial->getComId()) {
			$this->aCormecial = null;
		}
	} // ensureConsistency
	...
	{
		if ($this->aCormecial === null && ($this->fac_com_id !== null)) {
			$this->aCormecial = CormecialPeer::retrieveByPk($this->fac_com_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCormecial->addFacturacionyrecaudos($this);
			 */
		}
