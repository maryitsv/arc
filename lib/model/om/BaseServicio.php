...
abstract class BaseServicio extends BaseObject  implements Persistent {
	 ...
	 * related Periodoporprestadorservicios from storage. If this Servicio is new, it will return
		...
		if ($this->collPeriodoporprestadorservicios === null) {
			if ($this->isNew()) {
			   $this->collPeriodoporprestadorservicios = array();
				...
				$criteria->add(PeriodoporprestadorservicioPeer::PPS_SER_ID, $this->ser_id);
	 ...
	 */
	public function getPeriodoporprestadorserviciosJoinPrestador($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ServicioPeer::DATABASE_NAME);
		}
		...
		if ($this->collPeriodoporprestadorservicios === null) {
			if ($this->isNew()) {
				...
				$this->collPeriodoporprestadorservicios = PeriodoporprestadorservicioPeer::doSelectJoinPrestador($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
