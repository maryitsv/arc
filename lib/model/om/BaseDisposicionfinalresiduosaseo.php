...
abstract class BaseDisposicionfinalresiduosaseo extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the dfr_anios_utilizacion_sitio field.
	 * @var        int
	 */
	protected $dfr_anios_utilizacion_sitio;
	...
	/**
	 * Get the [dfr_anios_utilizacion_sitio] column value.
	 * 
	 * @return     int
	 */
	public function getDfrAniosUtilizacionSitio()
	{
		return $this->dfr_anios_utilizacion_sitio;
	}
	...
	/**
	 * Set the value of [dfr_anios_utilizacion_sitio] column.
	 * 
	 * @param      int $v new value
	 * @return     Disposicionfinalresiduosaseo The current object (for fluent API support)
	 */
	public function setDfrAniosUtilizacionSitio($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->dfr_anios_utilizacion_sitio !== $v) {
			$this->dfr_anios_utilizacion_sitio = $v;
			$this->modifiedColumns[] = DisposicionfinalresiduosaseoPeer::DFR_ANIOS_UTILIZACION_SITIO;
		}

		return $this;
	} // setDfrAniosUtilizacionSitio()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->dfr_contrata_disposicion_final = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			$this->dfr_cuenta_autorizacion_ambiental_disposicion = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			...
			$this->dfr_anios_utilizacion_sitio = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
			$this->dfr_area_destinada_para_disposicion_sitio = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->dfr_si_relleno_tipo_relleno = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->dfr_presencia_recicladores_sitio = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
			$this->dfr_cantidad_personas_sitio = ($row[$startcol + 24] !== null) ? (int) $row[$startcol + 24] : null;
			$this->dfr_tratamiento_lixiviados_sitio = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
			...
			$this->dfr_descarga_lixi_rio = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
			$this->dfr_descarga_lixi_lago = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
			$this->dfr_descarga_lixi_mar = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
			$this->dfr_descarga_lixi_suelo = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
			...
			$this->dfr_programa_control_vectores = ($row[$startcol + 43] !== null) ? (string) $row[$startcol + 43] : null;
			$this->dfr_programa_control_gases = ($row[$startcol + 44] !== null) ? (string) $row[$startcol + 44] : null;
			$this->resetModified();
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 19:
				...
				break;
			case 20:
				return $this->getDfrAniosUtilizacionSitio();
				break;
			case 21:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[20] => $this->getDfrAniosUtilizacionSitio(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 19:
				...
				break;
			case 20:
				$this->setDfrAniosUtilizacionSitio($value);
				break;
			case 21:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[20], $arr)) $this->setDfrAniosUtilizacionSitio($arr[$keys[20]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DisposicionfinalresiduosaseoPeer::DFR_ANIOS_UTILIZACION_SITIO)) $criteria->add(DisposicionfinalresiduosaseoPeer::DFR_ANIOS_UTILIZACION_SITIO, $this->dfr_anios_utilizacion_sitio);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDfrAniosUtilizacionSitio($this->dfr_anios_utilizacion_sitio);
