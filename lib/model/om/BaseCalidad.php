...
abstract class BaseCalidad extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the cal_nombre_diligenciador field.
	 * @var        string
	 */
	protected $cal_nombre_diligenciador;

	/**
	 * The value for the cal_apellido_diligenciador field.
	 * @var        string
	 */
	protected $cal_apellido_diligenciador;

	/**
	 * The value for the cal_cedula_diligenciador field.
	 * @var        string
	 */
	protected $cal_cedula_diligenciador;

	/**
	 * The value for the cal_telefono_diligenciador field.
	 * @var        string
	 */
	protected $cal_telefono_diligenciador;
	...
	/**
	 * Get the [cal_nombre_diligenciador] column value.
	 * 
	 * @return     string
	 */
	public function getCalNombreDiligenciador()
	{
		return $this->cal_nombre_diligenciador;
	}

	/**
	 * Get the [cal_apellido_diligenciador] column value.
	 * 
	 * @return     string
	 */
	public function getCalApellidoDiligenciador()
	{
		return $this->cal_apellido_diligenciador;
	}

	/**
	 * Get the [cal_cedula_diligenciador] column value.
	 * 
	 * @return     string
	 */
	public function getCalCedulaDiligenciador()
	{
		return $this->cal_cedula_diligenciador;
	}

	/**
	 * Get the [cal_telefono_diligenciador] column value.
	 * 
	 * @return     string
	 */
	public function getCalTelefonoDiligenciador()
	{
		return $this->cal_telefono_diligenciador;
	}
	...
	/**
	 * Set the value of [cal_nombre_diligenciador] column.
	 * 
	 * @param      string $v new value
	 * @return     Calidad The current object (for fluent API support)
	 */
	public function setCalNombreDiligenciador($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cal_nombre_diligenciador !== $v) {
			$this->cal_nombre_diligenciador = $v;
			$this->modifiedColumns[] = CalidadPeer::CAL_NOMBRE_DILIGENCIADOR;
		}

		return $this;
	} // setCalNombreDiligenciador()

	/**
	 * Set the value of [cal_apellido_diligenciador] column.
	 * 
	 * @param      string $v new value
	 * @return     Calidad The current object (for fluent API support)
	 */
	public function setCalApellidoDiligenciador($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cal_apellido_diligenciador !== $v) {
			$this->cal_apellido_diligenciador = $v;
			$this->modifiedColumns[] = CalidadPeer::CAL_APELLIDO_DILIGENCIADOR;
		}

		return $this;
	} // setCalApellidoDiligenciador()

	/**
	 * Set the value of [cal_cedula_diligenciador] column.
	 * 
	 * @param      string $v new value
	 * @return     Calidad The current object (for fluent API support)
	 */
	public function setCalCedulaDiligenciador($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cal_cedula_diligenciador !== $v) {
			$this->cal_cedula_diligenciador = $v;
			$this->modifiedColumns[] = CalidadPeer::CAL_CEDULA_DILIGENCIADOR;
		}

		return $this;
	} // setCalCedulaDiligenciador()

	/**
	 * Set the value of [cal_telefono_diligenciador] column.
	 * 
	 * @param      string $v new value
	 * @return     Calidad The current object (for fluent API support)
	 */
	public function setCalTelefonoDiligenciador($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cal_telefono_diligenciador !== $v) {
			$this->cal_telefono_diligenciador = $v;
			$this->modifiedColumns[] = CalidadPeer::CAL_TELEFONO_DILIGENCIADOR;
		}

		return $this;
	} // setCalTelefonoDiligenciador()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cal_nombre_diligenciador = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->cal_apellido_diligenciador = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->cal_cedula_diligenciador = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->cal_telefono_diligenciador = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = CalidadPeer::NUM_COLUMNS - CalidadPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				return $this->getCalNombreDiligenciador();
				break;
			case 5:
				return $this->getCalApellidoDiligenciador();
				break;
			case 6:
				return $this->getCalCedulaDiligenciador();
				break;
			case 7:
				return $this->getCalTelefonoDiligenciador();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getCalNombreDiligenciador(),
			$keys[5] => $this->getCalApellidoDiligenciador(),
			$keys[6] => $this->getCalCedulaDiligenciador(),
			$keys[7] => $this->getCalTelefonoDiligenciador(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				$this->setCalNombreDiligenciador($value);
				break;
			case 5:
				$this->setCalApellidoDiligenciador($value);
				break;
			case 6:
				$this->setCalCedulaDiligenciador($value);
				break;
			case 7:
				$this->setCalTelefonoDiligenciador($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setCalNombreDiligenciador($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setCalApellidoDiligenciador($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCalCedulaDiligenciador($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setCalTelefonoDiligenciador($arr[$keys[7]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CalidadPeer::CAL_NOMBRE_DILIGENCIADOR)) $criteria->add(CalidadPeer::CAL_NOMBRE_DILIGENCIADOR, $this->cal_nombre_diligenciador);
		if ($this->isColumnModified(CalidadPeer::CAL_APELLIDO_DILIGENCIADOR)) $criteria->add(CalidadPeer::CAL_APELLIDO_DILIGENCIADOR, $this->cal_apellido_diligenciador);
		if ($this->isColumnModified(CalidadPeer::CAL_CEDULA_DILIGENCIADOR)) $criteria->add(CalidadPeer::CAL_CEDULA_DILIGENCIADOR, $this->cal_cedula_diligenciador);
		if ($this->isColumnModified(CalidadPeer::CAL_TELEFONO_DILIGENCIADOR)) $criteria->add(CalidadPeer::CAL_TELEFONO_DILIGENCIADOR, $this->cal_telefono_diligenciador);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCalNombreDiligenciador($this->cal_nombre_diligenciador);

		$copyObj->setCalApellidoDiligenciador($this->cal_apellido_diligenciador);

		$copyObj->setCalCedulaDiligenciador($this->cal_cedula_diligenciador);

		$copyObj->setCalTelefonoDiligenciador($this->cal_telefono_diligenciador);
