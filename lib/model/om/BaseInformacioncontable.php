...
abstract class BaseInformacioncontable extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the ico_pasivo field.
	 * @var        string
	 */
	protected $ico_pasivo;
	...
	/**
	 * The value for the ico_costo_operacion_mantenimien field.
	 * @var        string
	 */
	protected $ico_costo_operacion_mantenimien;
	...
	/**
	 * Get the [ico_pasivo] column value.
	 * 
	 * @return     string
	 */
	public function getIcoPasivo()
	{
		return $this->ico_pasivo;
	}
	...
	/**
	 * Get the [ico_costo_operacion_mantenimien] column value.
	 * 
	 * @return     string
	 */
	public function getIcoCostoOperacionMantenimien()
	{
		return $this->ico_costo_operacion_mantenimien;
	}
	...
	/**
	 * Set the value of [ico_pasivo] column.
	 * 
	 * @param      string $v new value
	 * @return     Informacioncontable The current object (for fluent API support)
	 */
	public function setIcoPasivo($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->ico_pasivo !== $v) {
			$this->ico_pasivo = $v;
			$this->modifiedColumns[] = InformacioncontablePeer::ICO_PASIVO;
		}
	...
	/**
	 * Set the value of [ico_costo_operacion_mantenimien] column.
	 * 
	 * @param      string $v new value
	 * @return     Informacioncontable The current object (for fluent API support)
	 */
	public function setIcoCostoOperacionMantenimien($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->ico_costo_operacion_mantenimien !== $v) {
			$this->ico_costo_operacion_mantenimien = $v;
			$this->modifiedColumns[] = InformacioncontablePeer::ICO_COSTO_OPERACION_MANTENIMIEN;
		}

		return $this;
	} // setIcoCostoOperacionMantenimien()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ico_pasivo = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			...
			$this->ico_costo_operacion_mantenimien = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 23:
				...
				break;
			case 24:
				return $this->getIcoCostoOperacionMantenimien();
				break;
			case 25:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[24] => $this->getIcoCostoOperacionMantenimien(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 23:
				...
				break;
			case 24:
				$this->setIcoCostoOperacionMantenimien($value);
				break;
			case 25:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setIcoPasivo($arr[$keys[11]]);
		...
		if (array_key_exists($keys[24], $arr)) $this->setIcoCostoOperacionMantenimien($arr[$keys[24]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(InformacioncontablePeer::ICO_PASIVO)) $criteria->add(InformacioncontablePeer::ICO_PASIVO, $this->ico_pasivo);
		...
		if ($this->isColumnModified(InformacioncontablePeer::ICO_COSTO_OPERACION_MANTENIMIEN)) $criteria->add(InformacioncontablePeer::ICO_COSTO_OPERACION_MANTENIMIEN, $this->ico_costo_operacion_mantenimien);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIcoPasivo($this->ico_pasivo);
		...
		$copyObj->setIcoCostoOperacionMantenimien($this->ico_costo_operacion_mantenimien);
