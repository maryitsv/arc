...
/**
 * Base class that represents a row from the 'parametrospuntosred' table.
 *
 * 
 *
 ...
 */
abstract class BaseParametrospuntosred extends BaseObject  implements Persistent {
	 ...
	 * @var        ParametrospuntosredPeer
	 */
	protected static $peer;

	/**
	 * The value for the ppr_id field.
	 * @var        int
	 */
	protected $ppr_id;

	/**
	 * The value for the ppr_nombre_paramentro field.
	 * @var        string
	 */
	protected $ppr_nombre_paramentro;
	...
	const PEER = 'ParametrospuntosredPeer';

	/**
	 * Get the [ppr_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [ppr_nombre_paramentro] column value.
	 * 
	 * @return     string
	 */
	public function getPprNombreParamentro()
	{
		return $this->ppr_nombre_paramentro;
	}

	/**
	 * Set the value of [ppr_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Parametrospuntosred The current object (for fluent API support)
	 */
	public function setPprId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->ppr_id !== $v) {
			$this->ppr_id = $v;
			$this->modifiedColumns[] = ParametrospuntosredPeer::PPR_ID;
		}
	...
	/**
	 * Set the value of [ppr_nombre_paramentro] column.
	 * 
	 * @param      string $v new value
	 * @return     Parametrospuntosred The current object (for fluent API support)
	 */
	public function setPprNombreParamentro($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->ppr_nombre_paramentro !== $v) {
			$this->ppr_nombre_paramentro = $v;
			$this->modifiedColumns[] = ParametrospuntosredPeer::PPR_NOMBRE_PARAMENTRO;
		}

		return $this;
	} // setPprNombreParamentro()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ppr_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->ppr_nombre_paramentro = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = ParametrospuntosredPeer::NUM_COLUMNS - ParametrospuntosredPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Parametrospuntosred object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ParametrospuntosredPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseParametrospuntosred:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ParametrospuntosredPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseParametrospuntosred:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseParametrospuntosred:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseParametrospuntosred:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ParametrospuntosredPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ParametrospuntosredPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setPprId($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += ParametrospuntosredPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ParametrospuntosredPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ParametrospuntosredPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				return $this->getPprId();
				break;
			case 1:
				return $this->getPprNombreParamentro();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = ParametrospuntosredPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getPprId(),
			$keys[1] => $this->getPprNombreParamentro(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setPprNombreParamentro($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setPprId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setPprNombreParamentro($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ParametrospuntosredPeer::PPR_ID)) $criteria->add(ParametrospuntosredPeer::PPR_ID, $this->ppr_id);
		if ($this->isColumnModified(ParametrospuntosredPeer::PPR_NOMBRE_PARAMENTRO)) $criteria->add(ParametrospuntosredPeer::PPR_NOMBRE_PARAMENTRO, $this->ppr_nombre_paramentro);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ParametrospuntosredPeer::PPR_ID, $this->ppr_id);
	...
	/**
	 * Generic method to set the primary key (ppr_id column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Parametrospuntosred (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPprNombreParamentro($this->ppr_nombre_paramentro);
		...
		$copyObj->setPprId(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Parametrospuntosred Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ParametrospuntosredPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ParametrospuntosredPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Parametrospuntosred has previously been saved, it will retrieve
	 * related Parametroxfrecuencias from storage. If this Parametrospuntosred is new, it will return
		...
		if ($this->collParametroxfrecuencias === null) {
			if ($this->isNew()) {
			   $this->collParametroxfrecuencias = array();
				...
				$criteria->add(ParametroxfrecuenciaPeer::PFE_PPR_ID_PARAMENTRO, $this->ppr_id);
	 ...
	 * Otherwise if this Parametrospuntosred is new, it will return
	 * an empty collection; or if this Parametrospuntosred has previously
	 * been saved, it will retrieve related Parametroxfrecuencias from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Parametrospuntosred.
	 */
	public function getParametroxfrecuenciasJoinCalidadagua($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ParametrospuntosredPeer::DATABASE_NAME);
		}
		...
		if ($this->collParametroxfrecuencias === null) {
			if ($this->isNew()) {
				...
				$this->collParametroxfrecuencias = ParametroxfrecuenciaPeer::doSelectJoinCalidadagua($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Parametrospuntosred has previously been saved, it will retrieve
	 * related Resultadosxpuntos from storage. If this Parametrospuntosred is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collResultadosxpuntos === null) {
			if ($this->isNew()) {
			   $this->collResultadosxpuntos = array();
				...
				$criteria->add(ResultadosxpuntoPeer::REP_PPR_ID_PARAMENTRO, $this->ppr_id);
	 ...
	 * actually need in Parametrospuntosred.
	 */
	public function getResultadosxpuntosJoinCalidadagua($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ParametrospuntosredPeer::DATABASE_NAME);
		}
		...
		if ($this->collResultadosxpuntos === null) {
			if ($this->isNew()) {
				...
				$this->collResultadosxpuntos = ResultadosxpuntoPeer::doSelectJoinCalidadagua($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseParametrospuntosred:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseParametrospuntosred::%s', $method));
	  }
