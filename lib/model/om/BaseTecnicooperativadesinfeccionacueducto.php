...
abstract class BaseTecnicooperativadesinfeccionacueducto extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->toda_desinfeccion = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->toda_desinfeccion_cloro = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->toda_desinfeccion_hipoclorito_sodio = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->toda_desinfeccion_hipoclorito_calcio = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->toda_desinfeccion_ozonacion = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->toda_desinfeccion_rayos_ultravioleta = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->toda_desinfeccion_dioxido_cloro = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = TecnicooperativadesinfeccionacueductoPeer::NUM_COLUMNS - TecnicooperativadesinfeccionacueductoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getTodaDesinfeccionCloro(),
			$keys[4] => $this->getTodaDesinfeccionHipocloritoSodio(),
			$keys[5] => $this->getTodaDesinfeccionHipocloritoCalcio(),
			$keys[6] => $this->getTodaDesinfeccionOzonacion(),
			$keys[7] => $this->getTodaDesinfeccionRayosUltravioleta(),
			$keys[8] => $this->getTodaDesinfeccionDioxidoCloro(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setTodaDesinfeccionCloro($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setTodaDesinfeccionHipocloritoSodio($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setTodaDesinfeccionHipocloritoCalcio($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setTodaDesinfeccionOzonacion($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setTodaDesinfeccionRayosUltravioleta($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setTodaDesinfeccionDioxidoCloro($arr[$keys[8]]);
	}
