...
abstract class BaseTecnicooperativadesinfeccionacueducto extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->toda_desinfeccion_cloro = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->toda_desinfeccion_hipoclorito_sodio = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->toda_desinfeccion_hipoclorito_calcio = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->toda_desinfeccion_ozonacion = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->toda_desinfeccion_rayos_ultravioleta = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->toda_desinfeccion_dioxido_cloro = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
			$this->resetModified();
