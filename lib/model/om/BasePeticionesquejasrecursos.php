...
abstract class BasePeticionesquejasrecursos extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the pqr_cantida_pqr_prest_servicio field.
	 * @var        int
	 */
	protected $pqr_cantida_pqr_prest_servicio;
	...
	/**
	 * Get the [pqr_cantida_pqr_prest_servicio] column value.
	 * 
	 * @return     int
	 */
	public function getPqrCantidaPqrPrestServicio()
	{
		return $this->pqr_cantida_pqr_prest_servicio;
	}
	...
	/**
	 * Set the value of [pqr_cantida_pqr_prest_servicio] column.
	 * 
	 * @param      int $v new value
	 * @return     Peticionesquejasrecursos The current object (for fluent API support)
	 */
	public function setPqrCantidaPqrPrestServicio($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->pqr_cantida_pqr_prest_servicio !== $v) {
			$this->pqr_cantida_pqr_prest_servicio = $v;
			$this->modifiedColumns[] = PeticionesquejasrecursosPeer::PQR_CANTIDA_PQR_PREST_SERVICIO;
		}

		return $this;
	} // setPqrCantidaPqrPrestServicio()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->pqr_registro_pqr = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			...
			$this->pqr_cantida_pqr_prest_servicio = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			...
			$this->pqr_inf_causa_suspension_corte = ($row[$startcol + 9] !== null) ? (boolean) $row[$startcol + 9] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aCormecial !== null && $this->pqr_com_id !== $this->aCormecial->getComId()) {
			$this->aCormecial = null;
		}
	} // ensureConsistency
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 5:
				...
				break;
			case 6:
				return $this->getPqrCantidaPqrPrestServicio();
				break;
			case 7:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getPqrCantidaPqrPrestServicio(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 5:
				...
				break;
			case 6:
				$this->setPqrCantidaPqrPrestServicio($value);
				break;
			case 7:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setPqrCantidaPqrPrestServicio($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PeticionesquejasrecursosPeer::PQR_CANTIDA_PQR_PREST_SERVICIO)) $criteria->add(PeticionesquejasrecursosPeer::PQR_CANTIDA_PQR_PREST_SERVICIO, $this->pqr_cantida_pqr_prest_servicio);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPqrCantidaPqrPrestServicio($this->pqr_cantida_pqr_prest_servicio);
	...
	{
		if ($this->aCormecial === null && ($this->pqr_com_id !== null)) {
			$this->aCormecial = CormecialPeer::retrieveByPk($this->pqr_com_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCormecial->addPeticionesquejasrecursoss($this);
			 */
		}
