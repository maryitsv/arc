...
abstract class BaseTecnicooperativaacueducto extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the toa_tipos_sistema_abastecimiento field.
	 * @var        string
	 */
	protected $toa_tipos_sistema_abastecimiento;
	...
	/**
	 * The value for the toa_soluciones_poblacion_no_atendido_por_acueducto field.
	 * @var        string
	 */
	protected $toa_soluciones_poblacion_no_atendido_por_acueducto;
	...
	/**
	 * The value for the toa_toa_solucion_aljibe field.
	 * @var        boolean
	 */
	protected $toa_toa_solucion_aljibe;
	...
	/**
	 * Get the [toa_tipos_sistema_abastecimiento] column value.
	 * 
	 * @return     string
	 */
	public function getToaTiposSistemaAbastecimiento()
	{
		return $this->toa_tipos_sistema_abastecimiento;
	}
	...
	/**
	 * Get the [toa_soluciones_poblacion_no_atendido_por_acueducto] column value.
	 * 
	 * @return     string
	 */
	public function getToaSolucionesPoblacionNoAtendidoPorAcueducto()
	{
		return $this->toa_soluciones_poblacion_no_atendido_por_acueducto;
	}
	...
	/**
	 * Get the [toa_toa_solucion_aljibe] column value.
	 * 
	 * @return     boolean
	 */
	public function getToaToaSolucionAljibe()
	{
		return $this->toa_toa_solucion_aljibe;
	}
	...
	/**
	 * Set the value of [toa_tipos_sistema_abastecimiento] column.
	 * 
	 * @param      string $v new value
	 * @return     Tecnicooperativaacueducto The current object (for fluent API support)
	 */
	public function setToaTiposSistemaAbastecimiento($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->toa_tipos_sistema_abastecimiento !== $v) {
			$this->toa_tipos_sistema_abastecimiento = $v;
			$this->modifiedColumns[] = TecnicooperativaacueductoPeer::TOA_TIPOS_SISTEMA_ABASTECIMIENTO;
		}

		return $this;
	} // setToaTiposSistemaAbastecimiento()
	...
	/**
	 * Set the value of [toa_soluciones_poblacion_no_atendido_por_acueducto] column.
	 * 
	 * @param      string $v new value
	 * @return     Tecnicooperativaacueducto The current object (for fluent API support)
	 */
	public function setToaSolucionesPoblacionNoAtendidoPorAcueducto($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->toa_soluciones_poblacion_no_atendido_por_acueducto !== $v) {
			$this->toa_soluciones_poblacion_no_atendido_por_acueducto = $v;
			$this->modifiedColumns[] = TecnicooperativaacueductoPeer::TOA_SOLUCIONES_POBLACION_NO_ATENDIDO_POR_ACUEDUCTO;
		}

		return $this;
	} // setToaSolucionesPoblacionNoAtendidoPorAcueducto()
	...
	/**
	 * Set the value of [toa_toa_solucion_aljibe] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Tecnicooperativaacueducto The current object (for fluent API support)
	 */
	public function setToaToaSolucionAljibe($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->toa_toa_solucion_aljibe !== $v) {
			$this->toa_toa_solucion_aljibe = $v;
			$this->modifiedColumns[] = TecnicooperativaacueductoPeer::TOA_TOA_SOLUCION_ALJIBE;
		}

		return $this;
	} // setToaToaSolucionAljibe()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->toa_tipos_sistema_abastecimiento = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->toa_gravedad_sin_tratamiento = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->toa_bombeo_sin_tratamiento = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->toa_gravedad_con_tratamiento = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->toa_bombeo_con_tratamiento = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->toa_gravedad_bombeo_sin_tratamiento = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->toa_gravedad_bombeo_con_tratamiento = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
			$this->toa_gravedad_sin_tratamiento_bombeo_con_tratamiento = ($row[$startcol + 9] !== null) ? (boolean) $row[$startcol + 9] : null;
			$this->toa_gravedad_con_tratamiento_bombeo_sin_tratamiento = ($row[$startcol + 10] !== null) ? (boolean) $row[$startcol + 10] : null;
			$this->toa_cantidad_agua_distribuida_por_ano = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->toa_soluciones_poblacion_no_atendido_por_acueducto = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->toa_solucion_acarreo = ($row[$startcol + 13] !== null) ? (boolean) $row[$startcol + 13] : null;
			$this->toa_solucion_acarreo_viviendas = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->toa_solucion_nacimiento = ($row[$startcol + 15] !== null) ? (boolean) $row[$startcol + 15] : null;
			$this->toa_solucion_nacimiento_viviendas = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
			$this->toa_toa_solucion_aljibe = ($row[$startcol + 17] !== null) ? (boolean) $row[$startcol + 17] : null;
			$this->toa_solucion_aljibe_viviendas = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->toa_solucion_agua_lluvia = ($row[$startcol + 19] !== null) ? (boolean) $row[$startcol + 19] : null;
			$this->toa_solucion_agua_lluvia_viviendas = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
			$this->toa_solucion_otro = ($row[$startcol + 21] !== null) ? (boolean) $row[$startcol + 21] : null;
			$this->toa_solucion_otro_cual = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->toa_solucion_otro_viviendas = ($row[$startcol + 23] !== null) ? (int) $row[$startcol + 23] : null;
			$this->resetModified();
			...
			return $startcol + 24; // 24 = TecnicooperativaacueductoPeer::NUM_COLUMNS - TecnicooperativaacueductoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getToaTiposSistemaAbastecimiento();
				break;
			case 3:
			...
			case 11:
				...
				break;
			case 12:
				return $this->getToaSolucionesPoblacionNoAtendidoPorAcueducto();
				break;
			case 13:
			...
			case 16:
				...
				break;
			case 17:
				return $this->getToaToaSolucionAljibe();
				break;
			case 18:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getToaTiposSistemaAbastecimiento(),
			$keys[3] => $this->getToaGravedadSinTratamiento(),
			$keys[4] => $this->getToaBombeoSinTratamiento(),
			$keys[5] => $this->getToaGravedadConTratamiento(),
			$keys[6] => $this->getToaBombeoConTratamiento(),
			$keys[7] => $this->getToaGravedadBombeoSinTratamiento(),
			$keys[8] => $this->getToaGravedadBombeoConTratamiento(),
			$keys[9] => $this->getToaGravedadSinTratamientoBombeoConTratamiento(),
			$keys[10] => $this->getToaGravedadConTratamientoBombeoSinTratamiento(),
			$keys[11] => $this->getToaCantidadAguaDistribuidaPorAno(),
			$keys[12] => $this->getToaSolucionesPoblacionNoAtendidoPorAcueducto(),
			$keys[13] => $this->getToaSolucionAcarreo(),
			$keys[14] => $this->getToaSolucionAcarreoViviendas(),
			$keys[15] => $this->getToaSolucionNacimiento(),
			$keys[16] => $this->getToaSolucionNacimientoViviendas(),
			$keys[17] => $this->getToaToaSolucionAljibe(),
			$keys[18] => $this->getToaSolucionAljibeViviendas(),
			$keys[19] => $this->getToaSolucionAguaLluvia(),
			$keys[20] => $this->getToaSolucionAguaLluviaViviendas(),
			$keys[21] => $this->getToaSolucionOtro(),
			$keys[22] => $this->getToaSolucionOtroCual(),
			$keys[23] => $this->getToaSolucionOtroViviendas(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setToaTiposSistemaAbastecimiento($value);
				break;
			case 3:
			...
			case 11:
				...
				break;
			case 12:
				$this->setToaSolucionesPoblacionNoAtendidoPorAcueducto($value);
				break;
			case 13:
			...
			case 16:
				...
				break;
			case 17:
				$this->setToaToaSolucionAljibe($value);
				break;
			case 18:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setToaTiposSistemaAbastecimiento($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setToaGravedadSinTratamiento($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setToaBombeoSinTratamiento($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setToaGravedadConTratamiento($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setToaBombeoConTratamiento($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setToaGravedadBombeoSinTratamiento($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setToaGravedadBombeoConTratamiento($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setToaGravedadSinTratamientoBombeoConTratamiento($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setToaGravedadConTratamientoBombeoSinTratamiento($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setToaCantidadAguaDistribuidaPorAno($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setToaSolucionesPoblacionNoAtendidoPorAcueducto($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setToaSolucionAcarreo($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setToaSolucionAcarreoViviendas($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setToaSolucionNacimiento($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setToaSolucionNacimientoViviendas($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setToaToaSolucionAljibe($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setToaSolucionAljibeViviendas($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setToaSolucionAguaLluvia($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setToaSolucionAguaLluviaViviendas($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setToaSolucionOtro($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setToaSolucionOtroCual($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setToaSolucionOtroViviendas($arr[$keys[23]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TecnicooperativaacueductoPeer::TOA_TIPOS_SISTEMA_ABASTECIMIENTO)) $criteria->add(TecnicooperativaacueductoPeer::TOA_TIPOS_SISTEMA_ABASTECIMIENTO, $this->toa_tipos_sistema_abastecimiento);
		...
		if ($this->isColumnModified(TecnicooperativaacueductoPeer::TOA_SOLUCIONES_POBLACION_NO_ATENDIDO_POR_ACUEDUCTO)) $criteria->add(TecnicooperativaacueductoPeer::TOA_SOLUCIONES_POBLACION_NO_ATENDIDO_POR_ACUEDUCTO, $this->toa_soluciones_poblacion_no_atendido_por_acueducto);
		...
		if ($this->isColumnModified(TecnicooperativaacueductoPeer::TOA_TOA_SOLUCION_ALJIBE)) $criteria->add(TecnicooperativaacueductoPeer::TOA_TOA_SOLUCION_ALJIBE, $this->toa_toa_solucion_aljibe);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setToaTiposSistemaAbastecimiento($this->toa_tipos_sistema_abastecimiento);
		...
		$copyObj->setToaSolucionesPoblacionNoAtendidoPorAcueducto($this->toa_soluciones_poblacion_no_atendido_por_acueducto);
		...
		$copyObj->setToaToaSolucionAljibe($this->toa_toa_solucion_aljibe);
