...
abstract class BaseTecnicooperativaacueducto extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->toa_gravedad_sin_tratamiento = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->toa_bombeo_sin_tratamiento = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->toa_gravedad_con_tratamiento = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->toa_bombeo_con_tratamiento = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->toa_gravedad_bombeo_sin_tratamiento = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->toa_gravedad_bombeo_con_tratamiento = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->toa_gravedad_sin_tratamiento_bombeo_con_tratamiento = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
			$this->toa_gravedad_con_tratamiento_bombeo_sin_tratamiento = ($row[$startcol + 9] !== null) ? (boolean) $row[$startcol + 9] : null;
			$this->toa_cantidad_agua_distribuida_por_ano = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->toa_solucion_acarreo = ($row[$startcol + 11] !== null) ? (boolean) $row[$startcol + 11] : null;
			$this->toa_solucion_acarreo_viviendas = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
			$this->toa_solucion_nacimiento = ($row[$startcol + 13] !== null) ? (boolean) $row[$startcol + 13] : null;
			$this->toa_solucion_nacimiento_viviendas = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->toa_solucion_aljibe = ($row[$startcol + 15] !== null) ? (boolean) $row[$startcol + 15] : null;
			$this->toa_solucion_aljibe_viviendas = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
			$this->toa_solucion_agua_lluvia = ($row[$startcol + 17] !== null) ? (boolean) $row[$startcol + 17] : null;
			$this->toa_solucion_agua_lluvia_viviendas = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->toa_solucion_otro = ($row[$startcol + 19] !== null) ? (boolean) $row[$startcol + 19] : null;
