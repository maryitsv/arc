...
abstract class BaseFuenteenergia extends BaseObject  implements Persistent {
	 ...
	 * actually need in Fuenteenergia.
	 */
	public function getCaptacionsJoinTecnicooperativo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(FuenteenergiaPeer::DATABASE_NAME);
		}
		...
		if ($this->collCaptacions === null) {
			if ($this->isNew()) {
				...
				$this->collCaptacions = CaptacionPeer::doSelectJoinTecnicooperativo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
