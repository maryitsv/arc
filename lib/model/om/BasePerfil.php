...
abstract class BasePerfil extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the per_nombre field.
	 * @var        string
	 */
	...
	/**
	 * Get the [per_nombre] column value.
	 * 
	 * @return     string
	 */
	...
	public function setPerId($v)
	{
		...
		if ($this->per_id !== $v) {
			$this->per_id = $v;
			$this->modifiedColumns[] = PerfilPeer::PER_ID;
		}
	...
	/**
	 * Set the value of [per_nombre] column.
	 * 
	 * @param      string $v new value
	 * @return     Perfil The current object (for fluent API support)
	 */
	public function setPerNombre($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->per_nombre !== $v) {
			$this->per_nombre = $v;
			$this->modifiedColumns[] = PerfilPeer::PER_NOMBRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->per_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = PerfilPeer::NUM_COLUMNS - PerfilPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setPerId($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setPerId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setPerNombre($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PerfilPeer::PER_ID)) $criteria->add(PerfilPeer::PER_ID, $this->per_id);
		if ($this->isColumnModified(PerfilPeer::PER_NOMBRE)) $criteria->add(PerfilPeer::PER_NOMBRE, $this->per_nombre);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PerfilPeer::PER_ID, $this->per_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPerNombre($this->per_nombre);
		...
		$copyObj->setPerId(NULL); // this is a auto-increment column, so set to default value
		...
		if ($this->collUsuarios === null) {
			if ($this->isNew()) {
			   $this->collUsuarios = array();
				...
				$criteria->add(UsuarioPeer::USU_PER_ID, $this->per_id);
