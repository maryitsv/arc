...
/**
 * Base class that represents a row from the 'fuentesdubterraneas' table.
 *
 * 
 *
 ...
 */
abstract class BaseFuentesdubterraneas extends BaseObject  implements Persistent {
	...
	const PEER = 'FuentesdubterraneasPeer';
	 ...
	 * @return     Fuentesdubterraneas The current object (for fluent API support)
	 */
	public function setFsuId($v)
	{
		...
		if ($this->fsu_id !== $v) {
			$this->fsu_id = $v;
			$this->modifiedColumns[] = FuentesdubterraneasPeer::FSU_ID;
		}
	...
	public function setFsuFueId($v)
	{
		...
		if ($this->fsu_fue_id !== $v) {
			$this->fsu_fue_id = $v;
			$this->modifiedColumns[] = FuentesdubterraneasPeer::FSU_FUE_ID;
		}
	...
	public function setFsuNombre($v)
	{
		...
		if ($this->fsu_nombre !== $v) {
			$this->fsu_nombre = $v;
			$this->modifiedColumns[] = FuentesdubterraneasPeer::FSU_NOMBRE;
		}
	...
	public function setFsuPromedioCaptacion($v)
	{
		...
		if ($this->fsu_promedio_captacion !== $v) {
			...
			$this->modifiedColumns[] = FuentesdubterraneasPeer::FSU_PROMEDIO_CAPTACION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = FuentesdubterraneasPeer::NUM_COLUMNS - FuentesdubterraneasPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Fuentesdubterraneas object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = FuentesdubterraneasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseFuentesdubterraneas:delete:pre') as $callable)
			{
			...
			if ($ret) {
				FuentesdubterraneasPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseFuentesdubterraneas:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseFuentesdubterraneas:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseFuentesdubterraneas:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				FuentesdubterraneasPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FuentesdubterraneasPeer::doInsert($this, $con);
					...
					$affectedRows += FuentesdubterraneasPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FuentesdubterraneasPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FuentesdubterraneasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FuentesdubterraneasPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FuentesdubterraneasPeer::FSU_ID)) $criteria->add(FuentesdubterraneasPeer::FSU_ID, $this->fsu_id);
		if ($this->isColumnModified(FuentesdubterraneasPeer::FSU_FUE_ID)) $criteria->add(FuentesdubterraneasPeer::FSU_FUE_ID, $this->fsu_fue_id);
		if ($this->isColumnModified(FuentesdubterraneasPeer::FSU_NOMBRE)) $criteria->add(FuentesdubterraneasPeer::FSU_NOMBRE, $this->fsu_nombre);
		if ($this->isColumnModified(FuentesdubterraneasPeer::FSU_PROMEDIO_CAPTACION)) $criteria->add(FuentesdubterraneasPeer::FSU_PROMEDIO_CAPTACION, $this->fsu_promedio_captacion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FuentesdubterraneasPeer::FSU_ID, $this->fsu_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Fuentesdubterraneas (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Fuentesdubterraneas Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     FuentesdubterraneasPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new FuentesdubterraneasPeer();
		}
		return self::$peer;
	}
	...
	public function getFuentes(PropelPDO $con = null)
	{
		if ($this->aFuentes === null && ($this->fsu_fue_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aFuentes->addFuentesdubterraneass($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseFuentesdubterraneas:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseFuentesdubterraneas::%s', $method));
	  }
