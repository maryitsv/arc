...
abstract class BasePerfilPeer {
	...
	const PER_ID = 'perfil.PER_ID';

	/** the column name for the PER_NOMBRE field */
	const PER_NOMBRE = 'perfil.PER_NOMBRE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PerId', 'PerNombre', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('perId', 'perNombre', ),
		BasePeer::TYPE_COLNAME => array (self::PER_ID, self::PER_NOMBRE, ),
		BasePeer::TYPE_FIELDNAME => array ('per_id', 'per_nombre', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PerId' => 0, 'PerNombre' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('perId' => 0, 'perNombre' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::PER_ID => 0, self::PER_NOMBRE => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('per_id' => 0, 'per_nombre' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		$criteria->addSelectColumn(PerfilPeer::PER_ID);
		$criteria->addSelectColumn(PerfilPeer::PER_NOMBRE);
	}
    ...
    foreach (sfMixer::getCallables('BasePerfilPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePerfilPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(PerfilPeer::PER_ID) && $criteria->keyContainsValue(PerfilPeer::PER_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PerfilPeer::PER_ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BasePerfilPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePerfilPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PerfilPeer::PER_ID);
			$selectCriteria->add(PerfilPeer::PER_ID, $criteria->remove(PerfilPeer::PER_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PerfilPeer::PER_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(PerfilPeer::PER_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PerfilPeer::DATABASE_NAME);
			$criteria->add(PerfilPeer::PER_ID, $pks, Criteria::IN);
