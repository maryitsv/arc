...
abstract class BaseTecnicooperativadesarenadoracueducto extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->todes_bypass = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->todes_valvula = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->todes_aguas_erosion = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->resetModified();
