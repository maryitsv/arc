...
abstract class BaseTecnicooperativadesarenadoracueducto extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the todes_desarenador field.
	 * @var        string
	 */
	protected $todes_desarenador;
	...
	/**
	 * Get the [todes_desarenador] column value.
	 * 
	 * @return     string
	 */
	public function getTodesDesarenador()
	{
		return $this->todes_desarenador;
	}
	...
	/**
	 * Set the value of [todes_desarenador] column.
	 * 
	 * @param      string $v new value
	 * @return     Tecnicooperativadesarenadoracueducto The current object (for fluent API support)
	 */
	public function setTodesDesarenador($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->todes_desarenador !== $v) {
			$this->todes_desarenador = $v;
			$this->modifiedColumns[] = TecnicooperativadesarenadoracueductoPeer::TODES_DESARENADOR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->todes_desarenador = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->todes_bypass = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->todes_valvula = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->todes_aguas_erosion = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = TecnicooperativadesarenadoracueductoPeer::NUM_COLUMNS - TecnicooperativadesarenadoracueductoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getTodesDesarenador();
				break;
			case 3:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getTodesDesarenador(),
			$keys[3] => $this->getTodesBypass(),
			$keys[4] => $this->getTodesValvula(),
			$keys[5] => $this->getTodesAguasErosion(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setTodesDesarenador($value);
				break;
			case 3:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setTodesDesarenador($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setTodesBypass($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setTodesValvula($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setTodesAguasErosion($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TecnicooperativadesarenadoracueductoPeer::TODES_DESARENADOR)) $criteria->add(TecnicooperativadesarenadoracueductoPeer::TODES_DESARENADOR, $this->todes_desarenador);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTodesDesarenador($this->todes_desarenador);
