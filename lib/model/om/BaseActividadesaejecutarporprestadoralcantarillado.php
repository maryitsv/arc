...
/**
 * Base class that represents a row from the 'actividadesaejecutarporprestadoralcantarillado' table.
 *
 * 
 *
 ...
 */
abstract class BaseActividadesaejecutarporprestadoralcantarillado extends BaseObject  implements Persistent {
	 ...
	 * @var        ActividadesaejecutarporprestadoralcantarilladoPeer
	 */
	protected static $peer;

	/**
	 * The value for the aaep_id field.
	 * @var        int
	 */
	protected $aaep_id;

	/**
	 * The value for the aaep_nombre field.
	 * @var        string
	 */
	protected $aaep_nombre;
	...
	const PEER = 'ActividadesaejecutarporprestadoralcantarilladoPeer';

	/**
	 * Get the [aaep_id] column value.
	 * 
	 * @return     int
	 */
	public function getAaepId()
	{
		return $this->aaep_id;
	}

	/**
	 * Get the [aaep_nombre] column value.
	 * 
	 * @return     string
	 */
	public function getAaepNombre()
	{
		return $this->aaep_nombre;
	}

	/**
	 * Set the value of [aaep_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Actividadesaejecutarporprestadoralcantarillado The current object (for fluent API support)
	 */
	public function setAaepId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->aaep_id !== $v) {
			$this->aaep_id = $v;
			$this->modifiedColumns[] = ActividadesaejecutarporprestadoralcantarilladoPeer::AAEP_ID;
		}
	...
	/**
	 * Set the value of [aaep_nombre] column.
	 * 
	 * @param      string $v new value
	 * @return     Actividadesaejecutarporprestadoralcantarillado The current object (for fluent API support)
	 */
	public function setAaepNombre($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->aaep_nombre !== $v) {
			$this->aaep_nombre = $v;
			$this->modifiedColumns[] = ActividadesaejecutarporprestadoralcantarilladoPeer::AAEP_NOMBRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->aaep_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->aaep_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = ActividadesaejecutarporprestadoralcantarilladoPeer::NUM_COLUMNS - ActividadesaejecutarporprestadoralcantarilladoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Actividadesaejecutarporprestadoralcantarillado object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ActividadesaejecutarporprestadoralcantarilladoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseActividadesaejecutarporprestadoralcantarillado:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ActividadesaejecutarporprestadoralcantarilladoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseActividadesaejecutarporprestadoralcantarillado:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseActividadesaejecutarporprestadoralcantarillado:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseActividadesaejecutarporprestadoralcantarillado:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ActividadesaejecutarporprestadoralcantarilladoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ActividadesaejecutarporprestadoralcantarilladoPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setAaepId($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += ActividadesaejecutarporprestadoralcantarilladoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ActividadesaejecutarporprestadoralcantarilladoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ActividadesaejecutarporprestadoralcantarilladoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				return $this->getAaepId();
				break;
			case 1:
				return $this->getAaepNombre();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = ActividadesaejecutarporprestadoralcantarilladoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getAaepId(),
			$keys[1] => $this->getAaepNombre(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				$this->setAaepId($value);
				break;
			case 1:
				$this->setAaepNombre($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setAaepId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setAaepNombre($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActividadesaejecutarporprestadoralcantarilladoPeer::AAEP_ID)) $criteria->add(ActividadesaejecutarporprestadoralcantarilladoPeer::AAEP_ID, $this->aaep_id);
		if ($this->isColumnModified(ActividadesaejecutarporprestadoralcantarilladoPeer::AAEP_NOMBRE)) $criteria->add(ActividadesaejecutarporprestadoralcantarilladoPeer::AAEP_NOMBRE, $this->aaep_nombre);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ActividadesaejecutarporprestadoralcantarilladoPeer::AAEP_ID, $this->aaep_id);
	...
	/**
	 * Generic method to set the primary key (aaep_id column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Actividadesaejecutarporprestadoralcantarillado (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAaepNombre($this->aaep_nombre);
		...
		$copyObj->setAaepId(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Actividadesaejecutarporprestadoralcantarillado Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ActividadesaejecutarporprestadoralcantarilladoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ActividadesaejecutarporprestadoralcantarilladoPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Actividadesaejecutarporprestadoralcantarillado has previously been saved, it will retrieve
	 * related Tecnicooperativasolucioncolectivaalcantarillados from storage. If this Actividadesaejecutarporprestadoralcantarillado is new, it will return
		...
		if ($this->collTecnicooperativasolucioncolectivaalcantarillados === null) {
			if ($this->isNew()) {
			   $this->collTecnicooperativasolucioncolectivaalcantarillados = array();
				...
				$criteria->add(TecnicooperativasolucioncolectivaalcantarilladoPeer::TOSCA_ACTIVIDADES_A_EJECUTAR, $this->aaep_id);
	...
	public function addTecnicooperativasolucioncolectivaalcantarillado(Tecnicooperativasolucioncolectivaalcantarillado $l)
	{
		...
		if (!in_array($l, $this->collTecnicooperativasolucioncolectivaalcantarillados, true)) { // only add it if the **same** object is not already associated
			...
			$l->setActividadesaejecutarporprestadoralcantarillado($this);
		}
	}
	 ...
	 * Otherwise if this Actividadesaejecutarporprestadoralcantarillado is new, it will return
	 * an empty collection; or if this Actividadesaejecutarporprestadoralcantarillado has previously
	 * been saved, it will retrieve related Tecnicooperativasolucioncolectivaalcantarillados from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Actividadesaejecutarporprestadoralcantarillado.
	 */
	 ...
	 * actually need in Actividadesaejecutarporprestadoralcantarillado.
	 */
	public function getTecnicooperativasolucioncolectivaalcantarilladosJoinTecnicooperativo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ActividadesaejecutarporprestadoralcantarilladoPeer::DATABASE_NAME);
		}
		...
		if ($this->collTecnicooperativasolucioncolectivaalcantarillados === null) {
			if ($this->isNew()) {
				...
				$this->collTecnicooperativasolucioncolectivaalcantarillados = TecnicooperativasolucioncolectivaalcantarilladoPeer::doSelectJoinTecnicooperativo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseActividadesaejecutarporprestadoralcantarillado:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseActividadesaejecutarporprestadoralcantarillado::%s', $method));
	  }
...
} // BaseActividadesaejecutarporprestadoralcantarillado
