...
abstract class BaseCalidadcantidadagua extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cca_actividades_agricola_cultivos_permanentes = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->cca_actividades_agricola_cultivos_semipermanentes = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->cca_actividades_agricola_temporales = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->cca_actividad_pecuaria_ganaderia_bobina = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->cca_actividad_pecuaria_ganaderia_equina = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->cca_actividad_pecuaria_porcicultura = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->cca_actividad_pecuaria_capricultura_ovinos = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
			$this->cca_actividad_pecuaria_avicultura = ($row[$startcol + 9] !== null) ? (boolean) $row[$startcol + 9] : null;
			$this->cca_actividad_pecuaria_piscicultura = ($row[$startcol + 10] !== null) ? (boolean) $row[$startcol + 10] : null;
			$this->cca_actividad_pecuaria_otros_cual = ($row[$startcol + 11] !== null) ? (boolean) $row[$startcol + 11] : null;
			$this->cca_control_plagas_enfermedades_quimico = ($row[$startcol + 12] !== null) ? (boolean) $row[$startcol + 12] : null;
			$this->cca_control_plagas_enfermedades_organico = ($row[$startcol + 13] !== null) ? (boolean) $row[$startcol + 13] : null;
			$this->cca_control_plagas_enfermedades_biologico = ($row[$startcol + 14] !== null) ? (boolean) $row[$startcol + 14] : null;
			$this->cca_control_plagas_enfermedades_ninguno = ($row[$startcol + 15] !== null) ? (boolean) $row[$startcol + 15] : null;
			$this->cca_fertilizacion_cultivos_quimico = ($row[$startcol + 16] !== null) ? (boolean) $row[$startcol + 16] : null;
			$this->cca_fertilizacion_cultivos_organico = ($row[$startcol + 17] !== null) ? (boolean) $row[$startcol + 17] : null;
			$this->cca_fertilizacion_cultivos_ninguno = ($row[$startcol + 18] !== null) ? (boolean) $row[$startcol + 18] : null;
			$this->cca_capacitacion_dada_prestador = ($row[$startcol + 19] !== null) ? (boolean) $row[$startcol + 19] : null;
			$this->cca_control_malezas_quimico = ($row[$startcol + 20] !== null) ? (boolean) $row[$startcol + 20] : null;
			$this->cca_control_malezas_meca_manu = ($row[$startcol + 21] !== null) ? (boolean) $row[$startcol + 21] : null;
			$this->cca_control_malezas_organico = ($row[$startcol + 22] !== null) ? (boolean) $row[$startcol + 22] : null;
			$this->cca_control_malezas_ninguno = ($row[$startcol + 23] !== null) ? (boolean) $row[$startcol + 23] : null;
			$this->cca_mineria = ($row[$startcol + 24] !== null) ? (boolean) $row[$startcol + 24] : null;
			$this->cca_erosion = ($row[$startcol + 25] !== null) ? (boolean) $row[$startcol + 25] : null;
			$this->cca_modificaciones_paisaje_construcion_vias = ($row[$startcol + 26] !== null) ? (boolean) $row[$startcol + 26] : null;
			$this->cca_modificaciones_paisaje_construcion_vivienda = ($row[$startcol + 27] !== null) ? (boolean) $row[$startcol + 27] : null;
			$this->cca_modificaciones_paisaje_construcion_otro = ($row[$startcol + 28] !== null) ? (boolean) $row[$startcol + 28] : null;
			$this->cca_descargas_vivienda_liquido = ($row[$startcol + 29] !== null) ? (boolean) $row[$startcol + 29] : null;
			$this->cca_descargas_vivienda_solido = ($row[$startcol + 30] !== null) ? (boolean) $row[$startcol + 30] : null;
			$this->cca_descarga_actividad_productiva_agricola = ($row[$startcol + 31] !== null) ? (boolean) $row[$startcol + 31] : null;
			$this->cca_descarga_actividad_productiva_pecuaria = ($row[$startcol + 32] !== null) ? (boolean) $row[$startcol + 32] : null;
			$this->cca_descarga_actividad_productiva_minera = ($row[$startcol + 33] !== null) ? (boolean) $row[$startcol + 33] : null;
			$this->cca_descarga_actividad_productiva_industrial = ($row[$startcol + 34] !== null) ? (boolean) $row[$startcol + 34] : null;
			$this->cca_descarga_actividad_productiva_otra = ($row[$startcol + 35] !== null) ? (boolean) $row[$startcol + 35] : null;
			$this->resetModified();
			...
			return $startcol + 36; // 36 = CalidadcantidadaguaPeer::NUM_COLUMNS - CalidadcantidadaguaPeer::NUM_LAZY_LOAD_COLUMNS).
