...
abstract class BaseEstadogeneral extends BaseObject  implements Persistent {
	 ...
	 * actually need in Estadogeneral.
	 */
	public function getCaptacionsRelatedByCaptEstadoEstructuraIdJoinTecnicooperativo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstadogeneralPeer::DATABASE_NAME);
		}
		...
		if ($this->collCaptacionsRelatedByCaptEstadoEstructuraId === null) {
			if ($this->isNew()) {
				...
				$this->collCaptacionsRelatedByCaptEstadoEstructuraId = CaptacionPeer::doSelectJoinTecnicooperativo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in Estadogeneral.
	 */
	public function getCaptacionsRelatedByCaptEstadoPozoIdJoinTecnicooperativo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstadogeneralPeer::DATABASE_NAME);
		}
		...
		if ($this->collCaptacionsRelatedByCaptEstadoPozoId === null) {
			if ($this->isNew()) {
				...
				$this->collCaptacionsRelatedByCaptEstadoPozoId = CaptacionPeer::doSelectJoinTecnicooperativo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in Estadogeneral.
	 */
	public function getCaptacionsRelatedByCaptEstadoBombaIdJoinTecnicooperativo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstadogeneralPeer::DATABASE_NAME);
		}
		...
		if ($this->collCaptacionsRelatedByCaptEstadoBombaId === null) {
			if ($this->isNew()) {
				...
				$this->collCaptacionsRelatedByCaptEstadoBombaId = CaptacionPeer::doSelectJoinTecnicooperativo($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
