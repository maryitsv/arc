...
abstract class BaseDepartamento extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the dep_nombre field.
	 * @var        string
	 */
	protected $dep_nombre;

	/**
	 * The value for the dep_region field.
	 * @var        string
	 */
	protected $dep_region;

	/**
	 * The value for the dep_zona field.
	 * @var        string
	 */
	protected $dep_zona;
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collMunicipios.
	 */
	private $lastMunicipioCriteria = null;
	...
	/**
	 * Get the [dep_nombre] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [dep_region] column value.
	 * 
	 * @return     string
	 */
	public function getDepRegion()
	{
		return $this->dep_region;
	}

	/**
	 * Get the [dep_zona] column value.
	 * 
	 * @return     string
	 */
	public function getDepZona()
	{
		return $this->dep_zona;
	}
	...
	public function setDepId($v)
	{
		...
		if ($this->dep_id !== $v) {
			$this->dep_id = $v;
			$this->modifiedColumns[] = DepartamentoPeer::DEP_ID;
		}
	...
	/**
	 * Set the value of [dep_nombre] column.
	 * 
	...
	public function setDepNombre($v)
	{
		...
		if ($this->dep_nombre !== $v) {
			$this->dep_nombre = $v;
			$this->modifiedColumns[] = DepartamentoPeer::DEP_NOMBRE;
		}
	...
	/**
	 * Set the value of [dep_region] column.
	 * 
	 * @param      string $v new value
	 * @return     Departamento The current object (for fluent API support)
	 */
	public function setDepRegion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->dep_region !== $v) {
			$this->dep_region = $v;
			$this->modifiedColumns[] = DepartamentoPeer::DEP_REGION;
		}
	...
	/**
	 * Set the value of [dep_zona] column.
	 * 
	 * @param      string $v new value
	 * @return     Departamento The current object (for fluent API support)
	 */
	public function setDepZona($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->dep_zona !== $v) {
			$this->dep_zona = $v;
			$this->modifiedColumns[] = DepartamentoPeer::DEP_ZONA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->dep_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->dep_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->dep_region = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->dep_zona = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = DepartamentoPeer::NUM_COLUMNS - DepartamentoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastMunicipioCriteria = null;
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setDepId($pk);  //[IMV] update autoincrement primary key
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getDepRegion();
				break;
			case 3:
				return $this->getDepZona();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getDepId(),
			$keys[1] => $this->getDepNombre(),
			$keys[2] => $this->getDepRegion(),
			$keys[3] => $this->getDepZona(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setDepRegion($value);
				break;
			case 3:
				$this->setDepZona($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setDepId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setDepNombre($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setDepRegion($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setDepZona($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DepartamentoPeer::DEP_ID)) $criteria->add(DepartamentoPeer::DEP_ID, $this->dep_id);
		if ($this->isColumnModified(DepartamentoPeer::DEP_NOMBRE)) $criteria->add(DepartamentoPeer::DEP_NOMBRE, $this->dep_nombre);
		if ($this->isColumnModified(DepartamentoPeer::DEP_REGION)) $criteria->add(DepartamentoPeer::DEP_REGION, $this->dep_region);
		if ($this->isColumnModified(DepartamentoPeer::DEP_ZONA)) $criteria->add(DepartamentoPeer::DEP_ZONA, $this->dep_zona);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(DepartamentoPeer::DEP_ID, $this->dep_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDepRegion($this->dep_region);

		$copyObj->setDepZona($this->dep_zona);
		...
		$copyObj->setDepId(NULL); // this is a auto-increment column, so set to default value
	 ...
	 * related Disposicionfinalresiduosaseos from storage. If this Departamento is new, it will return
		...
		if ($this->collDisposicionfinalresiduosaseos === null) {
			if ($this->isNew()) {
			   $this->collDisposicionfinalresiduosaseos = array();
				...
				$criteria->add(DisposicionfinalresiduosaseoPeer::DFR_DEPARTAMENTO_DISPOCISION_ID, $this->dep_id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Departamento has previously been saved, it will retrieve
	 * related Informaciongeneralmicrocuencass from storage. If this Departamento is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collInformaciongeneralmicrocuencass === null) {
			if ($this->isNew()) {
			   $this->collInformaciongeneralmicrocuencass = array();
				...
				$criteria->add(InformaciongeneralmicrocuencasPeer::IMI_DEP_ID, $this->dep_id);
	...
	/**
	 * Clears out the collMunicipios collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collMunicipios collection (array).
	 *
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Departamento has previously been saved, it will retrieve
	 * related Municipios from storage. If this Departamento is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collMunicipios === null) {
			if ($this->isNew()) {
			   $this->collMunicipios = array();
				...
				$criteria->add(MunicipioPeer::MUN_DEP_ID, $this->dep_id);

				MunicipioPeer::addSelectColumns($criteria);
				$this->collMunicipios = MunicipioPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				MunicipioPeer::addSelectColumns($criteria);
				if (!isset($this->lastMunicipioCriteria) || !$this->lastMunicipioCriteria->equals($criteria)) {
					$this->collMunicipios = MunicipioPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastMunicipioCriteria = $criteria;
	...
	public function countMunicipios(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collMunicipios === null) {
			if ($this->isNew()) {
				...
				$count = MunicipioPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastMunicipioCriteria) || !$this->lastMunicipioCriteria->equals($criteria)) {
					...
					$count = count($this->collMunicipios);
				}
			} else {
				$count = count($this->collMunicipios);
			}
	...
	public function addMunicipio(Municipio $l)
	{
		...
		if (!in_array($l, $this->collMunicipios, true)) { // only add it if the **same** object is not already associated
			array_push($this->collMunicipios, $l);
			$l->setDepartamento($this);
		}
	}
