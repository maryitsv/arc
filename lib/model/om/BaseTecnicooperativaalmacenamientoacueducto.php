...
abstract class BaseTecnicooperativaalmacenamientoacueducto extends BaseObject  implements Persistent {
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TecnicooperativaalmacenamientoacueductoPeer::TOAA_TOP_ID, $this->toaa_top_id);
		$criteria->add(TecnicooperativaalmacenamientoacueductoPeer::TOAA_TAN_ID, $this->toaa_tan_id);
	...
	public function getPrimaryKey()
	{
		...
		$pks[0] = $this->getToaaId();

		$pks[1] = $this->getToaaTopId();

		$pks[2] = $this->getToaaTanId();
	...
	public function setPrimaryKey($keys)
	{
		...
		$this->setToaaId($keys[0]);

		$this->setToaaTopId($keys[1]);

		$this->setToaaTanId($keys[2]);
