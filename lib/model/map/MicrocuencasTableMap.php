...
class MicrocuencasTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('MIC_PPS_PRE_ID', 'MicPpsPreId', 'INTEGER', 'periodoporprestadorservicio', 'PPS_PRE_ID', false, null, null);
		$this->addColumn('MIC_PPS_ANIO', 'MicPpsAnio', 'INTEGER', false, null, null);
		$this->addColumn('MIC_PPS_SER_ID', 'MicPpsSerId', 'INTEGER', false, null, null);
		$this->addColumn('MIC_NOMBRE_DILIGENCIADOR', 'MicNombreDiligenciador', 'VARCHAR', false, 200, null);
		$this->addColumn('MIC_APELLIDO_DILIGENCIADOR', 'MicApellidoDiligenciador', 'VARCHAR', false, 200, null);
		$this->addColumn('MIC_CEDULA_DILIGENCIADOR', 'MicCedulaDiligenciador', 'VARCHAR', false, 15, null);
		$this->addColumn('MIC_TELEFONO_DILIGENCIADOR', 'MicTelefonoDiligenciador', 'VARCHAR', false, 15, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('AspectosLegales', 'AspectosLegales', RelationMap::ONE_TO_MANY, array('mic_id' => 'ale_mic_id', ), 'RESTRICT', 'CASCADE');
