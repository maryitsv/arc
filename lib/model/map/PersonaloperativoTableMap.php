...
class PersonaloperativoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('POP_CONTRATO_TERMINO_INDEFINIDO', 'PopContratoTerminoIndefinido', 'BOOLEAN', false, null, null);
		$this->addColumn('POP_CONTRATO_TERMINO_FIJO', 'PopContratoTerminoFijo', 'BOOLEAN', false, null, null);
		$this->addColumn('POP_ORDEN_PRESTACION_SERVICIOS', 'PopOrdenPrestacionServicios', 'BOOLEAN', false, null, null);
		$this->addColumn('POP_SIN_CONTRATO_CON_BONIFICACION', 'PopSinContratoConBonificacion', 'BOOLEAN', false, null, null);
