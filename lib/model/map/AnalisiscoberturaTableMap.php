...
class AnalisiscoberturaTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('ACO_COM_ID', 'AcoComId', 'INTEGER', 'cormecial', 'COM_ID', false, null, null);
		$this->addColumn('ACO_CATASTRO_USUARIOS', 'AcoCatastroUsuarios', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('ACO_ESTRAT_SOCECO_ADOP_MPIO', 'AcoEstratSocecoAdopMpio', 'BOOLEAN', false, null, null);
		$this->addColumn('ACO_ESTRA_SOCECO_ADOP_MPIO_JUS', 'AcoEstraSocecoAdopMpioJus', 'CHAR', false, 50, null);
		$this->addColumn('ACO_NUM_SUS_SERVICIO_OFICIAL', 'AcoNumSusServicioOficial', 'INTEGER', false, null, null);
		$this->addColumn('ACO_TARIF_ESTR_SERVICIO_OFICIAL', 'AcoTarifEstrServicioOficial', 'VARCHAR', false, 255, null);
		// validators
	} // initialize()
	...
	{
    $this->addRelation('Cormecial', 'Cormecial', RelationMap::MANY_TO_ONE, array('aco_com_id' => 'com_id', ), 'RESTRICT', 'CASCADE');
