...
class TecnicooperativareddistribucionacueductoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('TORD_TOP_ID', 'TordTopId', 'INTEGER', 'tecnicooperativo', 'TOP_ID', false, null, null);
		$this->addForeignKey('TORD_RED_DISTRIBUCION_ID', 'TordRedDistribucionId', 'INTEGER', 'reddistribucion', 'RDIST_ID', false, null, null);
		$this->addForeignKey('TORD_MATERIAL_DISTRIBUCION_ID', 'TordMaterialDistribucionId', 'INTEGER', 'materialreddistribucion', 'MRD_ID', false, null, null);
