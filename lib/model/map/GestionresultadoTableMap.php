...
class GestionresultadoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('GRE_IAF_ID', 'GreIafId', 'INTEGER', 'administrativafinanciera', 'IAF_ID', false, null, null);
		$this->addColumn('GRE_PLAN_GESTION_RESULTADOS', 'GrePlanGestionResultados', 'BOOLEAN', false, null, null);
		$this->addColumn('GRE_MICROMEDIDORES_FUNCIONANDO', 'GreMicromedidoresFuncionando', 'INTEGER', false, null, null);
		$this->addColumn('GRE_TOTAL_SUSCRIPTORES_MICROMED', 'GreTotalSuscriptoresMicromed', 'INTEGER', false, null, null);
		$this->addColumn('GRE_VALOR_MICOMEDICION', 'GreValorMicomedicion', 'VARCHAR', false, 255, null);
		...
		$this->addColumn('GRE_TOTAL_SUSCRIPTORES_FACTURAC', 'GreTotalSuscriptoresFacturac', 'INTEGER', false, null, null);
