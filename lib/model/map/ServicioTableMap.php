...
class ServicioTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('SER_NOMBRE', 'SerNombre', 'VARCHAR', false, 50, null);
		// validators
	} // initialize()
	...
	{
    $this->addRelation('Periodoporprestadorservicio', 'Periodoporprestadorservicio', RelationMap::ONE_TO_MANY, array('ser_id' => 'pps_ser_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
