...
class SuscriptoresservicioaseoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('SSASE_ACO_ID', 'SsaseAcoId', 'INTEGER', 'analisiscobertura', 'ACO_ID', false, null, null);
		$this->addForeignKey('SSASE_EST_ID', 'SsaseEstId', 'INTEGER', 'estrato', 'EST_ID', false, null, null);
