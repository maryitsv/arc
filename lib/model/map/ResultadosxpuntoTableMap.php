...
class ResultadosxpuntoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('REP_PPR_ID_PARAMENTRO', 'RepPprIdParamentro', 'INTEGER', 'parametrospuntosred', 'PPR_ID', false, null, null);
		$this->addForeignKey('REP_CAG_ID', 'RepCagId', 'INTEGER', 'calidadagua', 'CAG_ID', false, null, null);
