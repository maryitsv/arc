...
class CapacitacionTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('CAP_ACTIVIDAD_CAPACITACION_HIGIENE_PERSONAL_ACU', 'CapActividadCapacitacionHigienePersonalAcu', 'VARCHAR', false, 255, null);
		$this->addColumn('CAP_ACTIVIDAD_CAPACITACION_HIGIENE_VIVIENDA_ACU', 'CapActividadCapacitacionHigieneViviendaAcu', 'VARCHAR', false, 255, null);
		$this->addColumn('CAP_ACTIVIDAD_CAPACITACION_HIGIENE_SITIOS_PUBLICOS_ACU', 'CapActividadCapacitacionHigieneSitiosPublicosAcu', 'VARCHAR', false, 255, null);
		$this->addColumn('CAP_CAPACITACION_RECIBIDA_PRESTADOR_ACU', 'CapCapacitacionRecibidaPrestadorAcu', 'VARCHAR', false, 255, null);
