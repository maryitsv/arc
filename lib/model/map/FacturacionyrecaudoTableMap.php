...
class FacturacionyrecaudoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('FAC_COM_ID', 'FacComId', 'INTEGER', 'cormecial', 'COM_ID', false, null, null);
		$this->addColumn('FAC_FRECUENCIA_DEL_SERVICIO', 'FacFrecuenciaDelServicio', 'BOOLEAN', false, null, null);
		$this->addColumn('FAC_FRECUENC_FACTURACION', 'FacFrecuencFacturacion', 'VARCHAR', false, 255, null);
		$this->addColumn('FAC_FRECUENC_FAC_JUSTIFICACION', 'FacFrecuencFacJustificacion', 'CHAR', false, 30, null);
		...
		$this->addColumn('FAC_FRECUENCIA_FAC_JUSTIFICA', 'FacFrecuenciaFacJustifica', 'CHAR', false, 30, null);
	...
	{
    $this->addRelation('Cormecial', 'Cormecial', RelationMap::MANY_TO_ONE, array('fac_com_id' => 'com_id', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
