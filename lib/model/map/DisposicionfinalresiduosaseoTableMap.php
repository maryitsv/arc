...
class DisposicionfinalresiduosaseoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('DFR_AUTORIDAD_AUTONOMA_ID', 'DfrAutoridadAutonomaId', 'INTEGER', 'autoridadambiental', 'AUA_ID', false, null, null);
		$this->addForeignKey('DFR_ESTADO_VIA_ACCESO_SITIO_ID', 'DfrEstadoViaAccesoSitioId', 'INTEGER', 'estadogeneral', 'ESG_ID', false, null, null);
		$this->addForeignKey('DFR_DEPARTAMENTO_DISPOCISION_ID', 'DfrDepartamentoDispocisionId', 'INTEGER', 'departamento', 'DEP_ID', false, null, null);
		$this->addForeignKey('DFR_MUNICIPIO_DISPOSICION_ID', 'DfrMunicipioDisposicionId', 'INTEGER', 'municipio', 'MUN_ID', false, null, null);
		$this->addForeignKey('DFR_TOP_ID', 'DfrTopId', 'INTEGER', 'tecnicooperativo', 'TOP_ID', false, null, null);
