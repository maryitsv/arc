...
class TecnicooperativoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('TOP_NOMBRE_DILIGENCIADOR', 'TopNombreDiligenciador', 'VARCHAR', true, 200, null);
		$this->addColumn('TOP_APELLIDO_DILIGENCIADOR', 'TopApellidoDiligenciador', 'VARCHAR', true, 200, null);
		$this->addColumn('TOP_CEDULA_DILIGENCIADOR', 'TopCedulaDiligenciador', 'VARCHAR', true, 15, null);
