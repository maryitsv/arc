...
class TecnicooperativoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('TOP_PPS_PRE_ID', 'TopPpsPreId', 'INTEGER', 'periodoporprestadorservicio', 'PPS_PRE_ID', false, null, null);
		$this->addColumn('TOP_PPS_ANIO', 'TopPpsAnio', 'INTEGER', false, null, null);
		$this->addColumn('TOP_PPS_SER_ID', 'TopPpsSerId', 'INTEGER', false, null, null);
		$this->addColumn('TOP_NOMBRE_DILIGENCIADOR', 'TopNombreDiligenciador', 'VARCHAR', false, 200, null);
		$this->addColumn('TOP_APELLIDO_DILIGENCIADOR', 'TopApellidoDiligenciador', 'VARCHAR', false, 200, null);
		$this->addColumn('TOP_CEDULA_DILIGENCIADOR', 'TopCedulaDiligenciador', 'VARCHAR', false, 15, null);
		$this->addColumn('TOP_TELEFONO_DILIGENCIADOR', 'TopTelefonoDiligenciador', 'VARCHAR', false, 15, null);
		// validators
	} // initialize()
