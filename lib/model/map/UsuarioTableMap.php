...
class UsuarioTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('USU_PER_ID', 'UsuPerId', 'INTEGER', 'perfil', 'PER_ID', false, null, null);
		$this->addColumn('USU_LOGIN', 'UsuLogin', 'VARCHAR', false, 30, null);
		$this->addColumn('USU_CLAVE', 'UsuClave', 'VARCHAR', false, 30, null);
		// validators
	} // initialize()
