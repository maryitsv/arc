...
class TecnicooperativacomponentessistemaTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('TOCS_TOP_ID', 'TocsTopId', 'INTEGER', 'tecnicooperativo', 'TOP_ID', false, null, null);
		$this->addColumn('TOCS_COMPONENTES', 'TocsComponentes', 'VARCHAR', false, 100, null);
		$this->addColumn('TOCS_CAPTACION', 'TocsCaptacion', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_CAPTACION_CANTIDAD', 'TocsCaptacionCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_ADUCCION', 'TocsAduccion', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_ADUCCION_CANTIDAD', 'TocsAduccionCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_DESARENADOR', 'TocsDesarenador', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_DESARENADOR_CANTIDAD', 'TocsDesarenadorCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_CONDUCCION_AGUA_CRUDA', 'TocsConduccionAguaCruda', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_CONDUCCION_AGUA_CRUDA_CANTIDAD', 'TocsConduccionAguaCrudaCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_PLANTA_TRATAMIENTO', 'TocsPlantaTratamiento', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_PLANTA_TRATAMIENTO_CANTIDAD', 'TocsPlantaTratamientoCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_DESINFECCION', 'TocsDesinfeccion', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_DESINFECCION_CANTIDAD', 'TocsDesinfeccionCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_TANQUE_ALMACENAMIENTO', 'TocsTanqueAlmacenamiento', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_TANQUE_ALMACENAMIENTO_CANTIDAD', 'TocsTanqueAlmacenamientoCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_CONDUCCION_AGUA_TRATADA', 'TocsConduccionAguaTratada', 'BOOLEAN', false, null, null);
		$this->addColumn('TOCS_CONDUCCION_AGUA_TRATADA_CANTIDAD', 'TocsConduccionAguaTratadaCantidad', 'INTEGER', false, null, null);
		$this->addColumn('TOCS_RED_DISTRIBUCION', 'TocsRedDistribucion', 'BOOLEAN', false, null, null);
