...
class SuscriptoresservicioacueductoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('SSACU_ACO_ID', 'SsacuAcoId', 'INTEGER', 'analisiscobertura', 'ACO_ID', false, null, null);
		$this->addForeignKey('SSACU_EST_ID', 'SsacuEstId', 'INTEGER', 'estrato', 'EST_ID', false, null, null);
		$this->addColumn('SSACU_NUMERO_SUSCRIPTORES', 'SsacuNumeroSuscriptores', 'INTEGER', false, null, null);
