...
class AdministrativafinancieraTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('IAF_PPS_PRE_ID', 'IafPpsPreId', 'INTEGER', 'periodoporprestadorservicio', 'PPS_PRE_ID', false, null, null);
		$this->addColumn('IAF_PPS_ANIO', 'IafPpsAnio', 'INTEGER', false, null, null);
		$this->addColumn('IAF_PPS_SER_ID', 'IafPpsSerId', 'INTEGER', false, null, null);
		$this->addColumn('IAF_NOMBRE_DILIGENCIADOR', 'IafNombreDiligenciador', 'VARCHAR', false, 200, null);
		$this->addColumn('IAF_APELLIDO_DILIGENCIADOR', 'IafApellidoDiligenciador', 'VARCHAR', false, 200, null);
		$this->addColumn('IAF_CEDULA_DILIGENCIADOR', 'IafCedulaDiligenciador', 'VARCHAR', false, 15, null);
		$this->addColumn('IAF_TELEFONO_DILIGENCIADOR', 'IafTelefonoDiligenciador', 'VARCHAR', false, 15, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('Trabajadoresyvinculacion', 'Trabajadoresyvinculacion', RelationMap::ONE_TO_MANY, array('iaf_id' => 'tra_iaf_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
