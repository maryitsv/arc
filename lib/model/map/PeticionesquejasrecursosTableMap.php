...
class PeticionesquejasrecursosTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('PQR_COM_ID', 'PqrComId', 'INTEGER', 'cormecial', 'COM_ID', false, null, null);
		...
		$this->addColumn('PQR_CANTIDA_PQR_PREST_SERVICIO', 'PqrCantidaPqrPrestServicio', 'INTEGER', false, null, null);
	...
	{
    $this->addRelation('Cormecial', 'Cormecial', RelationMap::MANY_TO_ONE, array('pqr_com_id' => 'com_id', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
