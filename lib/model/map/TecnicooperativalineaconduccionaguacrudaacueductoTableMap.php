...
class TecnicooperativalineaconduccionaguacrudaacueductoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('TOLC_TOP_ID', 'TolcTopId', 'INTEGER', 'tecnicooperativo', 'TOP_ID', false, null, null);
		$this->addForeignKey('TOLC_TIPO_CANAL_ID', 'TolcTipoCanalId', 'INTEGER', 'tipocanal', 'TCA_ID', false, null, null);
		$this->addForeignKey('TOLC_MATERIAL_CANAL_ID', 'TolcMaterialCanalId', 'INTEGER', 'materialcanal', 'MCA_ID', false, null, null);
