...
class TecnicooperativasolucioncolectivaalcantarilladoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('TOSCA_POSEE_ALCANTARILLADO_COLECTIVO', 'ToscaPoseeAlcantarilladoColectivo', 'BOOLEAN', false, null, null);
		$this->addColumn('TOSCA_SANITARIO_FUNCIONA', 'ToscaSanitarioFunciona', 'BOOLEAN', false, null, null);
		$this->addColumn('TOSCA_SANITARIO_NUMERO_SUSCRIPTORES', 'ToscaSanitarioNumeroSuscriptores', 'INTEGER', false, null, null);
		$this->addColumn('TOSCA_SANITARIO_SE_USA', 'ToscaSanitarioSeUsa', 'BOOLEAN', false, null, null);
		$this->addForeignKey('TOSCA_SANITARIO_ESTADO', 'ToscaSanitarioEstado', 'INTEGER', 'estadogeneral', 'ESG_ID', false, null, null);
		$this->addColumn('TOSCA_PLUVIAL_FUNCIONA', 'ToscaPluvialFunciona', 'BOOLEAN', false, null, null);
		$this->addColumn('TOSCA_PLUVIAL_NUMERO_SUSCRIPTORES', 'ToscaPluvialNumeroSuscriptores', 'INTEGER', false, null, null);
		$this->addColumn('TOSCA_PLUVIAL_SE_USA', 'ToscaPluvialSeUsa', 'BOOLEAN', false, null, null);
		$this->addForeignKey('TOSCA_PLUVIAL_ESTADO', 'ToscaPluvialEstado', 'INTEGER', 'estadogeneral', 'ESG_ID', false, null, null);
		$this->addColumn('TOSCA_COMBI_CONVENCIONAL_FUNCIONA', 'ToscaCombiConvencionalFunciona', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('TOSCA_COMBI_CONVENCIONAL_SE_USA', 'ToscaCombiConvencionalSeUsa', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('TOSCA_COMBI_NO_CONVENCIONAL_FUNCIONA', 'ToscaCombiNoConvencionalFunciona', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('TOSCA_COMBI_NO_CONVENCIONAL_SE_USA', 'ToscaCombiNoConvencionalSeUsa', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('TOSCA_SIMPLIFICADO_FUNCIONA', 'ToscaSimplificadoFunciona', 'BOOLEAN', false, null, null);
		$this->addColumn('TOSCA_SIMPLIFICADO_NUMERO_SUSCRIPTORES', 'ToscaSimplificadoNumeroSuscriptores', 'INTEGER', false, null, null);
		$this->addColumn('TOSCA_SIMPLIFICADO_SE_USA', 'ToscaSimplificadoSeUsa', 'BOOLEAN', false, null, null);
		$this->addForeignKey('TOSCA_SIMPLIFICADO_ESTADO', 'ToscaSimplificadoEstado', 'INTEGER', 'estadogeneral', 'ESG_ID', false, null, null);
		$this->addColumn('TOSCA_SIN_ARRASTRE_SOLIDOS_FUNCIONA', 'ToscaSinArrastreSolidosFunciona', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('TOSCA_SIN_ARRASTRE_SOLIDOS_SE_USA', 'ToscaSinArrastreSolidosSeUsa', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('TOSCA_OTRO_FUNCIONA', 'ToscaOtroFunciona', 'BOOLEAN', false, null, null);
		$this->addColumn('TOSCA_OTRO_NUMERO_SUSCRIPTORES', 'ToscaOtroNumeroSuscriptores', 'INTEGER', false, null, null);
		$this->addColumn('TOSCA_OTRO_SE_USA', 'ToscaOtroSeUsa', 'BOOLEAN', false, null, null);
