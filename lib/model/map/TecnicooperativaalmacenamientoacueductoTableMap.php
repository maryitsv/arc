...
class TecnicooperativaalmacenamientoacueductoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignPrimaryKey('TOAA_TOP_ID', 'ToaaTopId', 'INTEGER' , 'tecnicooperativo', 'TOP_ID', true, null, null);
		$this->addForeignPrimaryKey('TOAA_TAN_ID', 'ToaaTanId', 'INTEGER' , 'tanque', 'TAN_ID', true, null, null);
		// validators
	} // initialize()
