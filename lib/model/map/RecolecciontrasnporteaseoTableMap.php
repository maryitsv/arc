...
class RecolecciontrasnporteaseoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('RTR_TIPO_RECOLECCION_SELECTIVA', 'RtrTipoRecoleccionSelectiva', 'VARCHAR', false, 255, null);
		$this->addColumn('RTR_TIPO_RECOLECCION_CONJUNTIVA', 'RtrTipoRecoleccionConjuntiva', 'VARCHAR', false, 255, null);
