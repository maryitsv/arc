...
class TecnicooperativacaptacionacueductoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignPrimaryKey('TOCA_TOP_ID', 'TocaTopId', 'INTEGER' , 'tecnicooperativo', 'TOP_ID', true, null, null);
		$this->addForeignPrimaryKey('TOCA_CAPT_ID', 'TocaCaptId', 'INTEGER' , 'captacion', 'CAPT_ID', true, null, null);
		// validators
	} // initialize()
