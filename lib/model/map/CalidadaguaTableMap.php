...
class CalidadaguaTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('CAG_CONTROL_CA_FUENTE', 'CagControlCaFuente', 'VARCHAR', false, 255, null);
		$this->addColumn('CAG_MAPA_RIESGO', 'CagMapaRiesgo', 'VARCHAR', false, 255, null);
		...
		$this->addColumn('CAG_LABORATORIO_PROPIO', 'CagLaboratorioPropio', 'VARCHAR', false, 255, null);
		$this->addColumn('CAG_CONTROL_CA_DISTRIBUIDA', 'CagControlCaDistribuida', 'VARCHAR', false, 255, null);
		$this->addColumn('CAG_NUMERO_VISITA_SSPD', 'CagNumeroVisitaSspd', 'INTEGER', false, null, null);
		// validators
	} // initialize()
