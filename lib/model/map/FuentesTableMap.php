...
class FuentesTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('FUE_MIC_ID', 'FueMicId', 'INTEGER', 'microcuencas', 'MIC_ID', false, null, null);
    ...
    $this->addRelation('Cantidadaguafuentessuperficiales', 'Cantidadaguafuentessuperficiales', RelationMap::ONE_TO_MANY, array('fue_id' => 'caf_fue_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Fuentesdubterraneas', 'Fuentesdubterraneas', RelationMap::ONE_TO_MANY, array('fue_id' => 'fsu_fue_id', ), 'RESTRICT', 'RESTRICT');
