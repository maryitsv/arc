...
class FuentesTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('FUE_TIENE_FUENTES_SUPERFICIALES', 'FueTieneFuentesSuperficiales', 'VARCHAR', false, 255, null);
		$this->addColumn('FUE_TIENE_FUENTES_SUBTERRANEAS', 'FueTieneFuentesSubterraneas', 'VARCHAR', false, 255, null);
		$this->addColumn('FUE_COMPRA_AGUA_BLOQUE', 'FueCompraAguaBloque', 'VARCHAR', false, 255, null);
		$this->addColumn('FUE_NUMERO_FUENTES_SUPERFICIALES', 'FueNumeroFuentesSuperficiales', 'INTEGER', false, null, null);
