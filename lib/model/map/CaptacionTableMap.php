...
class CaptacionTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('CAPT_ESTADO_POZO_ID', 'CaptEstadoPozoId', 'INTEGER', 'estadogeneral', 'ESG_ID', false, null, null);
		$this->addForeignKey('CAPT_ESTADO_BOMBA_ID', 'CaptEstadoBombaId', 'INTEGER', 'estadogeneral', 'ESG_ID', false, null, null);
		$this->addForeignKey('CAPT_FUENTE_ENERGIA_ID', 'CaptFuenteEnergiaId', 'INTEGER', 'fuenteenergia', 'FEN_ID', false, null, null);
		// validators
	} // initialize()
