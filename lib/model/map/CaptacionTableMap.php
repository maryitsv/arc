...
class CaptacionTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('CAPT_FUENTE_SUPERFICIAL', 'CaptFuenteSuperficial', 'VARCHAR', false, 255, null);
		$this->addForeignKey('CAPT_TOP_ID', 'CaptTopId', 'INTEGER', 'tecnicooperativo', 'TOP_ID', true, null, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('Tecnicooperativo', 'Tecnicooperativo', RelationMap::MANY_TO_ONE, array('capt_top_id' => 'top_id', ), null, 'CASCADE');
	} // buildRelations()
