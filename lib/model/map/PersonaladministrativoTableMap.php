...
class PersonaladministrativoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PAD_CONTRATO_TERMINO_INDEFINIDO', 'PadContratoTerminoIndefinido', 'BOOLEAN', false, null, null);
		$this->addColumn('PAD_CONTRATO_TERMINO_FIJO', 'PadContratoTerminoFijo', 'BOOLEAN', false, null, null);
		$this->addColumn('PAD_ORDEN_PESTACION_SERVICIOS', 'PadOrdenPestacionServicios', 'BOOLEAN', false, null, null);
		$this->addColumn('PAD_SIN_CONTRATO_CON_BONIFICACION', 'PadSinContratoConBonificacion', 'BOOLEAN', false, null, null);
