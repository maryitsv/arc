...
class TecnicooperativaacueductoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('TOA_TOP_ID', 'ToaTopId', 'INTEGER', 'tecnicooperativo', 'TOP_ID', false, null, null);
		$this->addColumn('TOA_TIPOS_SISTEMA_ABASTECIMIENTO', 'ToaTiposSistemaAbastecimiento', 'VARCHAR', false, 100, null);
		...
		$this->addColumn('TOA_SOLUCIONES_POBLACION_NO_ATENDIDO_POR_ACUEDUCTO', 'ToaSolucionesPoblacionNoAtendidoPorAcueducto', 'VARCHAR', false, 100, null);
		...
		$this->addColumn('TOA_TOA_SOLUCION_ALJIBE', 'ToaToaSolucionAljibe', 'BOOLEAN', false, null, null);
