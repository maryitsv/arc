...
class PeriodoporprestadorservicioTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PPS_NUMERO_SUSCRIPTORES', 'PpsNumeroSuscriptores', 'VARCHAR', true, 255, null);
		...
		$this->addColumn('PPS_TIPO_IDENTIFICACION_DILIGENCIADOR', 'PpsTipoIdentificacionDiligenciador', 'VARCHAR', true, 50, null);
		$this->addColumn('PPS_IDENTIFICACION_DILIGENCIADOR', 'PpsIdentificacionDiligenciador', 'VARCHAR', true, 15, null);
