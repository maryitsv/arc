...
class PeriodoporprestadorservicioTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PPS_ESTATUTOS', 'PpsEstatutos', 'BOOLEAN', false, null, null);
		...
		$this->addColumn('PPS_NOMBRE_DILIGENCIADOR', 'PpsNombreDiligenciador', 'VARCHAR', true, 200, null);
		$this->addColumn('PPS_APELLIDO_DILIGENCIADOR', 'PpsApellidoDiligenciador', 'VARCHAR', true, 200, null);
		$this->addColumn('PPS_CEDULA_DILIGENCIADOR', 'PpsCedulaDiligenciador', 'VARCHAR', true, 15, null);
