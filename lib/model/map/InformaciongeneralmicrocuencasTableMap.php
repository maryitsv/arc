...
class InformaciongeneralmicrocuencasTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('IMI_MIC_ID', 'ImiMicId', 'INTEGER', 'microcuencas', 'MIC_ID', false, null, null);
		$this->addForeignKey('IMI_DEP_ID', 'ImiDepId', 'INTEGER', 'departamento', 'DEP_ID', false, null, null);
		$this->addForeignKey('IMI_MUN_ID', 'ImiMunId', 'INTEGER', 'municipio', 'MUN_ID', false, null, null);
		$this->addColumn('IMI_LOCALIDAD', 'ImiLocalidad', 'VARCHAR', false, 100, null);
		$this->addColumn('IMI_MICROCUENTA', 'ImiMicrocuenta', 'VARCHAR', false, 100, null);
